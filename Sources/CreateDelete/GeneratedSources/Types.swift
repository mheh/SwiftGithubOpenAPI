...
public protocol APIProtocol: Sendable {
    /// Create
    ///
    /// - Remark: HTTP `POST /create`.
    /// - Remark: Generated from `#/paths//create/post(create)`.
    ...
    ///
    /// - Remark: HTTP `POST /delete`.
    /// - Remark: Generated from `#/paths//delete/post(delete)`.
...
extension APIProtocol {
    ...
    public func delete(
        ...
        body: Operations.Delete.Input.Body
...
public enum Components {
    ...
    public enum Schemas {
        ...
        ///
        /// - Remark: Generated from `#/components/schemas/webhook-create`.
        public struct WebhookCreate: Codable, Hashable, Sendable {
            /// The repository's current description.
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-create/description`.
            public var description: Swift.String?
            /// - Remark: Generated from `#/components/schemas/webhook-create/enterprise`.
            public var enterprise: Components.Schemas.Enterprise?
            /// - Remark: Generated from `#/components/schemas/webhook-create/installation`.
            public var installation: Components.Schemas.SimpleInstallation?
            /// The name of the repository's default branch (usually `main`).
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-create/master_branch`.
            public var masterBranch: Swift.String
            /// - Remark: Generated from `#/components/schemas/webhook-create/organization`.
            public var organization: Components.Schemas.OrganizationSimple?
            /// The pusher type for the event. Can be either `user` or a deploy key.
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-create/pusher_type`.
            public var pusherType: Swift.String
            /// The [`git ref`](https://docs.github.com/en/rest/reference/git#get-a-reference) resource.
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-create/ref`.
            public var ref: Swift.String
            /// The type of Git ref object created in the repository.
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-create/ref_type`.
            @frozen public enum RefTypePayload: String, Codable, Hashable, Sendable, CaseIterable {
                case tag = "tag"
                case branch = "branch"
            }
            /// The type of Git ref object created in the repository.
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-create/ref_type`.
            public var refType: Components.Schemas.WebhookCreate.RefTypePayload
            /// - Remark: Generated from `#/components/schemas/webhook-create/repository`.
            public var repository: Components.Schemas.Repository
            /// - Remark: Generated from `#/components/schemas/webhook-create/sender`.
            public var sender: Components.Schemas.SimpleUser
            /// Creates a new `WebhookCreate`.
            ///
            /// - Parameters:
            ...
            ///   - ref: The [`git ref`](https://docs.github.com/en/rest/reference/git#get-a-reference) resource.
            ...
            public init(
                ...
                ref: Swift.String,
                refType: Components.Schemas.WebhookCreate.RefTypePayload,
        ...
        ///
        ///
        /// - Remark: Generated from `#/components/schemas/webhook-delete`.
        public struct WebhookDelete: Codable, Hashable, Sendable {
            /// - Remark: Generated from `#/components/schemas/webhook-delete/enterprise`.
            public var enterprise: Components.Schemas.Enterprise?
            /// - Remark: Generated from `#/components/schemas/webhook-delete/installation`.
            public var installation: Components.Schemas.SimpleInstallation?
            /// - Remark: Generated from `#/components/schemas/webhook-delete/organization`.
            public var organization: Components.Schemas.OrganizationSimple?
            /// The pusher type for the event. Can be either `user` or a deploy key.
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-delete/pusher_type`.
            public var pusherType: Swift.String
            /// The [`git ref`](https://docs.github.com/en/rest/reference/git#get-a-reference) resource.
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-delete/ref`.
            public var ref: Swift.String
            /// The type of Git ref object deleted in the repository.
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-delete/ref_type`.
            @frozen public enum RefTypePayload: String, Codable, Hashable, Sendable, CaseIterable {
                case tag = "tag"
                case branch = "branch"
            }
            ...
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-delete/ref_type`.
            public var refType: Components.Schemas.WebhookDelete.RefTypePayload
            /// - Remark: Generated from `#/components/schemas/webhook-delete/repository`.
            public var repository: Components.Schemas.Repository
            /// - Remark: Generated from `#/components/schemas/webhook-delete/sender`.
            public var sender: Components.Schemas.SimpleUser
            /// Creates a new `WebhookDelete`.
            ///
            /// - Parameters:
            ///   - enterprise:
            ///   - installation:
            ...
            public init(
                ...
                pusherType: Swift.String,
                ref: Swift.String,
                refType: Components.Schemas.WebhookDelete.RefTypePayload,
                repository: Components.Schemas.Repository,
                sender: Components.Schemas.SimpleUser
            ) {
                self.enterprise = enterprise
...
public enum Operations {
    ...
    public enum Create {
        ...
        public struct Input: Sendable, Hashable {
            /// - Remark: Generated from `#/paths/create/POST/header`.
            public struct Headers: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/create/POST/header/User-Agent`.
                public var userAgent: Swift.String?
                /// - Remark: Generated from `#/paths/create/POST/header/X-Github-Hook-Id`.
                public var xGithubHookId: Swift.String?
                /// - Remark: Generated from `#/paths/create/POST/header/X-Github-Event`.
                public var xGithubEvent: Swift.String?
                /// - Remark: Generated from `#/paths/create/POST/header/X-Github-Hook-Installation-Target-Id`.
                public var xGithubHookInstallationTargetId: Swift.String?
                /// - Remark: Generated from `#/paths/create/POST/header/X-Github-Hook-Installation-Target-Type`.
                public var xGithubHookInstallationTargetType: Swift.String?
                /// - Remark: Generated from `#/paths/create/POST/header/X-GitHub-Delivery`.
                public var xGitHubDelivery: Swift.String?
                /// - Remark: Generated from `#/paths/create/POST/header/X-Hub-Signature-256`.
            ...
            /// - Remark: Generated from `#/paths/create/POST/requestBody`.
            @frozen public enum Body: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/create/POST/requestBody/content/application\/json`.
                case json(Components.Schemas.WebhookCreate)
            }
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            ///
            /// - Remark: Generated from `#/paths//create/post(create)/responses/200`.
            ///
            /// HTTP response code: `200 ok`.
            case ok(Operations.Create.Output.Ok)
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//create/post(create)/responses/200`.
            ///
            ...
            /// - SeeAlso: `.ok`.
            public var ok: Operations.Create.Output.Ok {
                get throws {
                    switch self {
    ...
    public enum Delete {
        ...
        public struct Input: Sendable, Hashable {
            /// - Remark: Generated from `#/paths/delete/POST/header`.
            public struct Headers: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/delete/POST/header/User-Agent`.
                public var userAgent: Swift.String?
                /// - Remark: Generated from `#/paths/delete/POST/header/X-Github-Hook-Id`.
                public var xGithubHookId: Swift.String?
                /// - Remark: Generated from `#/paths/delete/POST/header/X-Github-Event`.
                public var xGithubEvent: Swift.String?
                /// - Remark: Generated from `#/paths/delete/POST/header/X-Github-Hook-Installation-Target-Id`.
                public var xGithubHookInstallationTargetId: Swift.String?
                /// - Remark: Generated from `#/paths/delete/POST/header/X-Github-Hook-Installation-Target-Type`.
                public var xGithubHookInstallationTargetType: Swift.String?
                /// - Remark: Generated from `#/paths/delete/POST/header/X-GitHub-Delivery`.
                public var xGitHubDelivery: Swift.String?
                /// - Remark: Generated from `#/paths/delete/POST/header/X-Hub-Signature-256`.
                public var xHubSignature256: Swift.String?
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
            ...
            /// - Remark: Generated from `#/paths/delete/POST/requestBody`.
            @frozen public enum Body: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/delete/POST/requestBody/content/application\/json`.
                case json(Components.Schemas.WebhookDelete)
            }
            public var body: Operations.Delete.Input.Body
            /// Creates a new `Input`.
            ///
            /// - Parameters:
            ///   - headers:
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//delete/post(delete)/responses/200`.
            ///
            /// HTTP response code: `200 ok`.
            case ok(Operations.Delete.Output.Ok)
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//delete/post(delete)/responses/200`.
            ///
            ...
            /// - Throws: An error if `self` is not `.ok`.
            /// - SeeAlso: `.ok`.
            public var ok: Operations.Delete.Output.Ok {
                get throws {
                    switch self {
                    case let .ok(response):
                        return response
