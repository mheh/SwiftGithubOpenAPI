...
public protocol APIProtocol: Sendable {
    ...
    ///
    /// - Remark: HTTP `POST /secret-scanning-alert-created`.
    /// - Remark: Generated from `#/paths//secret-scanning-alert-created/post(secret-scanning-alert/created)`.
    func secretScanningAlertCreated(_ input: Operations.SecretScanningAlertCreated.Input) async throws -> Operations.SecretScanningAlertCreated.Output
    ...
    ///
    /// - Remark: HTTP `POST /secret-scanning-alert-location-created`.
    /// - Remark: Generated from `#/paths//secret-scanning-alert-location-created/post(secret-scanning-alert-location/created)`.
    func secretScanningAlertLocationCreated(_ input: Operations.SecretScanningAlertLocationCreated.Input) async throws -> Operations.SecretScanningAlertLocationCreated.Output
    /// This event occurs when there is activity relating to a secret scanning alert.
    ///
    /// For more information about secret scanning, see "[About secret scanning](https://docs.github.com/code-security/secret-scanning/about-secret-scanning)." For information about the API to manage secret scanning alerts, see [the REST API documentation](https://docs.github.com/rest/secret-scanning).
    ///
    ...
    ///
    /// - Remark: HTTP `POST /secret-scanning-alert-reopened`.
    /// - Remark: Generated from `#/paths//secret-scanning-alert-reopened/post(secret-scanning-alert/reopened)`.
    func secretScanningAlertReopened(_ input: Operations.SecretScanningAlertReopened.Input) async throws -> Operations.SecretScanningAlertReopened.Output
    /// This event occurs when there is activity relating to a secret scanning alert.
    ///
    /// For more information about secret scanning, see "[About secret scanning](https://docs.github.com/code-security/secret-scanning/about-secret-scanning)." For information about the API to manage secret scanning alerts, see [the REST API documentation](https://docs.github.com/rest/secret-scanning).
    ///
    ...
    ///
    /// - Remark: HTTP `POST /secret-scanning-alert-resolved`.
    /// - Remark: Generated from `#/paths//secret-scanning-alert-resolved/post(secret-scanning-alert/resolved)`.
    func secretScanningAlertResolved(_ input: Operations.SecretScanningAlertResolved.Input) async throws -> Operations.SecretScanningAlertResolved.Output
    /// This event occurs when there is activity relating to a secret scanning alert.
    ///
    /// For more information about secret scanning, see "[About secret scanning](https://docs.github.com/code-security/secret-scanning/about-secret-scanning)." For information about the API to manage secret scanning alerts, see [the REST API documentation](https://docs.github.com/rest/secret-scanning).
    ///
    ...
    ///
    /// - Remark: HTTP `POST /secret-scanning-alert-revoked`.
    /// - Remark: Generated from `#/paths//secret-scanning-alert-revoked/post(secret-scanning-alert/revoked)`.
    func secretScanningAlertRevoked(_ input: Operations.SecretScanningAlertRevoked.Input) async throws -> Operations.SecretScanningAlertRevoked.Output
}
...
extension APIProtocol {
    ...
    /// - Remark: HTTP `POST /secret-scanning-alert-created`.
    /// - Remark: Generated from `#/paths//secret-scanning-alert-created/post(secret-scanning-alert/created)`.
    public func secretScanningAlertCreated(
        headers: Operations.SecretScanningAlertCreated.Input.Headers = .init(),
        body: Operations.SecretScanningAlertCreated.Input.Body
    ) async throws -> Operations.SecretScanningAlertCreated.Output {
        try await secretScanningAlertCreated(Operations.SecretScanningAlertCreated.Input(
            headers: headers,
            body: body
        ))
    }
    ...
    /// - Remark: HTTP `POST /secret-scanning-alert-location-created`.
    /// - Remark: Generated from `#/paths//secret-scanning-alert-location-created/post(secret-scanning-alert-location/created)`.
    public func secretScanningAlertLocationCreated(
        headers: Operations.SecretScanningAlertLocationCreated.Input.Headers = .init(),
        body: Operations.SecretScanningAlertLocationCreated.Input.Body
    ) async throws -> Operations.SecretScanningAlertLocationCreated.Output {
        try await secretScanningAlertLocationCreated(Operations.SecretScanningAlertLocationCreated.Input(
            headers: headers,
            body: body
        ))
    }
    ...
    /// - Remark: HTTP `POST /secret-scanning-alert-reopened`.
    /// - Remark: Generated from `#/paths//secret-scanning-alert-reopened/post(secret-scanning-alert/reopened)`.
    public func secretScanningAlertReopened(
        headers: Operations.SecretScanningAlertReopened.Input.Headers = .init(),
        body: Operations.SecretScanningAlertReopened.Input.Body
    ) async throws -> Operations.SecretScanningAlertReopened.Output {
        try await secretScanningAlertReopened(Operations.SecretScanningAlertReopened.Input(
            headers: headers,
            body: body
        ))
    }
    ...
    /// - Remark: HTTP `POST /secret-scanning-alert-resolved`.
    /// - Remark: Generated from `#/paths//secret-scanning-alert-resolved/post(secret-scanning-alert/resolved)`.
    public func secretScanningAlertResolved(
        headers: Operations.SecretScanningAlertResolved.Input.Headers = .init(),
        body: Operations.SecretScanningAlertResolved.Input.Body
    ) async throws -> Operations.SecretScanningAlertResolved.Output {
        try await secretScanningAlertResolved(Operations.SecretScanningAlertResolved.Input(
            headers: headers,
            body: body
        ))
    }
    ...
    /// - Remark: HTTP `POST /secret-scanning-alert-revoked`.
    /// - Remark: Generated from `#/paths//secret-scanning-alert-revoked/post(secret-scanning-alert/revoked)`.
    public func secretScanningAlertRevoked(
        headers: Operations.SecretScanningAlertRevoked.Input.Headers = .init(),
        body: Operations.SecretScanningAlertRevoked.Input.Body
    ) async throws -> Operations.SecretScanningAlertRevoked.Output {
        try await secretScanningAlertRevoked(Operations.SecretScanningAlertRevoked.Input(
            headers: headers,
            body: body
        ))
    }
...
public enum Components {
    ...
    public enum Schemas {
        ...
        public struct SecretScanningLocation: Codable, Hashable, Sendable {
            ...
            ///
            /// - Parameters:
            ///   - _type: The location type. Because secrets may be found in different types of resources (ie. code, comments, issues), this field identifies the type of resource where the secret was found.
            ///   - details:
            public init(
                _type: Components.Schemas.SecretScanningLocation._TypePayload,
                details: Components.Schemas.SecretScanningLocation.DetailsPayload
            ) {
                self._type = _type
        ...
        /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-created`.
        public struct WebhookSecretScanningAlertCreated: Codable, Hashable, Sendable {
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-created/action`.
            @frozen public enum ActionPayload: String, Codable, Hashable, Sendable, CaseIterable {
                case created = "created"
            }
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-created/action`.
            public var action: Components.Schemas.WebhookSecretScanningAlertCreated.ActionPayload
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-created/alert`.
            public var alert: Components.Schemas.SecretScanningAlert
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-created/enterprise`.
            public var enterprise: Components.Schemas.Enterprise?
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-created/installation`.
            public var installation: Components.Schemas.SimpleInstallation?
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-created/organization`.
            public var organization: Components.Schemas.OrganizationSimple?
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-created/repository`.
            public var repository: Components.Schemas.Repository
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-created/sender`.
            public var sender: Components.Schemas.SimpleUser?
            /// Creates a new `WebhookSecretScanningAlertCreated`.
            ///
            /// - Parameters:
            ///   - action:
            ///   - alert:
            ...
            ///   - sender:
            public init(
                action: Components.Schemas.WebhookSecretScanningAlertCreated.ActionPayload,
                alert: Components.Schemas.SecretScanningAlert,
        ...
        /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-location-created`.
        public struct WebhookSecretScanningAlertLocationCreated: Codable, Hashable, Sendable {
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-location-created/action`.
            @frozen public enum ActionPayload: String, Codable, Hashable, Sendable, CaseIterable {
                case created = "created"
            }
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-location-created/action`.
            public var action: Components.Schemas.WebhookSecretScanningAlertLocationCreated.ActionPayload?
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-location-created/alert`.
            public var alert: Components.Schemas.SecretScanningAlert
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-location-created/installation`.
            public var installation: Components.Schemas.SimpleInstallation?
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-location-created/location`.
            public var location: Components.Schemas.SecretScanningLocation
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-location-created/organization`.
            public var organization: Components.Schemas.OrganizationSimple?
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-location-created/repository`.
            public var repository: Components.Schemas.Repository
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-location-created/sender`.
            public var sender: Components.Schemas.SimpleUser
            /// Creates a new `WebhookSecretScanningAlertLocationCreated`.
            ///
            /// - Parameters:
            ///   - action:
            ///   - alert:
            ...
            ///   - sender:
            public init(
                action: Components.Schemas.WebhookSecretScanningAlertLocationCreated.ActionPayload? = nil,
                alert: Components.Schemas.SecretScanningAlert,
                installation: Components.Schemas.SimpleInstallation? = nil,
                location: Components.Schemas.SecretScanningLocation,
                organization: Components.Schemas.OrganizationSimple? = nil,
                repository: Components.Schemas.Repository,
        ...
        /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-location-created-form-encoded`.
        public struct WebhookSecretScanningAlertLocationCreatedFormEncoded: Codable, Hashable, Sendable {
            /// A URL-encoded string of the secret_scanning_alert_location.created JSON payload. The decoded payload is a JSON object.
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-location-created-form-encoded/payload`.
            public var payload: Swift.String
            /// Creates a new `WebhookSecretScanningAlertLocationCreatedFormEncoded`.
            ///
            /// - Parameters:
        ...
        /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-reopened`.
        public struct WebhookSecretScanningAlertReopened: Codable, Hashable, Sendable {
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-reopened/action`.
            @frozen public enum ActionPayload: String, Codable, Hashable, Sendable, CaseIterable {
                case reopened = "reopened"
            }
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-reopened/action`.
            public var action: Components.Schemas.WebhookSecretScanningAlertReopened.ActionPayload
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-reopened/alert`.
            public var alert: Components.Schemas.SecretScanningAlert
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-reopened/enterprise`.
            public var enterprise: Components.Schemas.Enterprise?
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-reopened/installation`.
            public var installation: Components.Schemas.SimpleInstallation?
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-reopened/organization`.
            public var organization: Components.Schemas.OrganizationSimple?
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-reopened/repository`.
            public var repository: Components.Schemas.Repository
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-reopened/sender`.
            public var sender: Components.Schemas.SimpleUser?
            /// Creates a new `WebhookSecretScanningAlertReopened`.
            ///
            /// - Parameters:
            ///   - action:
            ///   - alert:
            ...
            ///   - sender:
            public init(
                action: Components.Schemas.WebhookSecretScanningAlertReopened.ActionPayload,
                alert: Components.Schemas.SecretScanningAlert,
                enterprise: Components.Schemas.Enterprise? = nil,
                installation: Components.Schemas.SimpleInstallation? = nil,
                organization: Components.Schemas.OrganizationSimple? = nil,
        ...
        /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved`.
        public struct WebhookSecretScanningAlertResolved: Codable, Hashable, Sendable {
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/action`.
            @frozen public enum ActionPayload: String, Codable, Hashable, Sendable, CaseIterable {
                case resolved = "resolved"
            }
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/action`.
            public var action: Components.Schemas.WebhookSecretScanningAlertResolved.ActionPayload
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/alert`.
            public struct AlertPayload: Codable, Hashable, Sendable {
                /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/alert/created_at`.
                public var createdAt: Components.Schemas.AlertCreatedAt?
                /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/alert/html_url`.
                public var htmlUrl: Components.Schemas.AlertHtmlUrl?
                /// The REST API URL of the code locations for this alert.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/alert/locations_url`.
                public var locationsUrl: Swift.String?
                /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/alert/number`.
                public var number: Components.Schemas.AlertNumber?
                /// Whether push protection was bypassed for the detected secret.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/alert/push_protection_bypassed`.
                public var pushProtectionBypassed: Swift.Bool?
                /// The time that push protection was bypassed in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ`.
                ///
                ...
                /// **Required when the `state` is `resolved`.** The reason for resolving the alert.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/alert/resolution`.
                @frozen public enum ResolutionPayload: String, Codable, Hashable, Sendable, CaseIterable {
                    ...
                    case revoked = "revoked"
                    case usedInTests = "used_in_tests"
                    case patternDeleted = "pattern_deleted"
                    case patternEdited = "pattern_edited"
                }
                /// **Required when the `state` is `resolved`.** The reason for resolving the alert.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/alert/resolution`.
                public var resolution: Components.Schemas.WebhookSecretScanningAlertResolved.AlertPayload.ResolutionPayload?
                /// The time that the alert was resolved in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ`.
                ///
                ...
                /// An optional comment to resolve an alert.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/alert/resolution_comment`.
                public var resolutionComment: Swift.String?
                /// The secret that was detected.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/alert/secret`.
                public var secret: Swift.String?
                /// The type of secret that secret scanning detected.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/alert/secret_type`.
                public var secretType: Swift.String?
                /// User-friendly name for the detected secret, matching the `secret_type`.
                /// For a list of built-in patterns, see "[Secret scanning patterns](https://docs.github.com/code-security/secret-scanning/secret-scanning-patterns#supported-secrets-for-advanced-security)."
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/alert/secret_type_display_name`.
                public var secretTypeDisplayName: Swift.String?
                /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/alert/state`.
                public var state: Components.Schemas.SecretScanningAlertState?
                /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/alert/updated_at`.
                public var updatedAt: Components.Schemas.AlertUpdatedAt?
                /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/alert/url`.
                public var url: Components.Schemas.AlertUrl?
            ...
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/alert`.
            public var alert: Components.Schemas.WebhookSecretScanningAlertResolved.AlertPayload
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/enterprise`.
            public var enterprise: Components.Schemas.Enterprise?
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/installation`.
            public var installation: Components.Schemas.SimpleInstallation?
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/organization`.
            public var organization: Components.Schemas.OrganizationSimple?
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/repository`.
            public var repository: Components.Schemas.Repository
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-resolved/sender`.
            public var sender: Components.Schemas.SimpleUser?
            /// Creates a new `WebhookSecretScanningAlertResolved`.
            ///
            /// - Parameters:
            ///   - action:
            ///   - alert:
            ...
            ///   - sender:
            public init(
                action: Components.Schemas.WebhookSecretScanningAlertResolved.ActionPayload,
                alert: Components.Schemas.WebhookSecretScanningAlertResolved.AlertPayload,
                enterprise: Components.Schemas.Enterprise? = nil,
                installation: Components.Schemas.SimpleInstallation? = nil,
                organization: Components.Schemas.OrganizationSimple? = nil,
                repository: Components.Schemas.Repository,
        ...
        /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-revoked`.
        public struct WebhookSecretScanningAlertRevoked: Codable, Hashable, Sendable {
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-revoked/action`.
            @frozen public enum ActionPayload: String, Codable, Hashable, Sendable, CaseIterable {
                case revoked = "revoked"
            }
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-revoked/action`.
            public var action: Components.Schemas.WebhookSecretScanningAlertRevoked.ActionPayload
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-revoked/alert`.
            public var alert: Components.Schemas.SecretScanningAlert
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-revoked/enterprise`.
            public var enterprise: Components.Schemas.Enterprise?
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-revoked/installation`.
            public var installation: Components.Schemas.SimpleInstallation?
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-revoked/organization`.
            public var organization: Components.Schemas.OrganizationSimple?
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-revoked/repository`.
            public var repository: Components.Schemas.Repository
            /// - Remark: Generated from `#/components/schemas/webhook-secret-scanning-alert-revoked/sender`.
            public var sender: Components.Schemas.SimpleUser?
            /// Creates a new `WebhookSecretScanningAlertRevoked`.
            ///
            /// - Parameters:
            ///   - action:
            ///   - alert:
            ...
            ///   - sender:
            public init(
                action: Components.Schemas.WebhookSecretScanningAlertRevoked.ActionPayload,
                alert: Components.Schemas.SecretScanningAlert,
                enterprise: Components.Schemas.Enterprise? = nil,
                installation: Components.Schemas.SimpleInstallation? = nil,
                organization: Components.Schemas.OrganizationSimple? = nil,
...
public enum Operations {
    ...
    /// - Remark: HTTP `POST /secret-scanning-alert-created`.
    /// - Remark: Generated from `#/paths//secret-scanning-alert-created/post(secret-scanning-alert/created)`.
    public enum SecretScanningAlertCreated {
        public static let id: Swift.String = "secret-scanning-alert/created"
        public struct Input: Sendable, Hashable {
            /// - Remark: Generated from `#/paths/secret-scanning-alert-created/POST/header`.
            public struct Headers: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/secret-scanning-alert-created/POST/header/User-Agent`.
                public var userAgent: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-created/POST/header/X-Github-Hook-Id`.
                public var xGithubHookId: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-created/POST/header/X-Github-Event`.
                public var xGithubEvent: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-created/POST/header/X-Github-Hook-Installation-Target-Id`.
                public var xGithubHookInstallationTargetId: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-created/POST/header/X-Github-Hook-Installation-Target-Type`.
                public var xGithubHookInstallationTargetType: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-created/POST/header/X-GitHub-Delivery`.
                public var xGitHubDelivery: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-created/POST/header/X-Hub-Signature-256`.
            ...
            public var headers: Operations.SecretScanningAlertCreated.Input.Headers
            /// - Remark: Generated from `#/paths/secret-scanning-alert-created/POST/requestBody`.
            @frozen public enum Body: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/secret-scanning-alert-created/POST/requestBody/content/application\/json`.
                case json(Components.Schemas.WebhookSecretScanningAlertCreated)
            }
            public var body: Operations.SecretScanningAlertCreated.Input.Body
            /// Creates a new `Input`.
            ///
            /// - Parameters:
            ///   - headers:
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            ///
            /// - Remark: Generated from `#/paths//secret-scanning-alert-created/post(secret-scanning-alert/created)/responses/200`.
            ///
            /// HTTP response code: `200 ok`.
            case ok(Operations.SecretScanningAlertCreated.Output.Ok)
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//secret-scanning-alert-created/post(secret-scanning-alert/created)/responses/200`.
            ///
            ...
            /// - SeeAlso: `.ok`.
            public var ok: Operations.SecretScanningAlertCreated.Output.Ok {
                get throws {
                    switch self {
    ...
    /// - Remark: HTTP `POST /secret-scanning-alert-location-created`.
    /// - Remark: Generated from `#/paths//secret-scanning-alert-location-created/post(secret-scanning-alert-location/created)`.
    public enum SecretScanningAlertLocationCreated {
        public static let id: Swift.String = "secret-scanning-alert-location/created"
        public struct Input: Sendable, Hashable {
            /// - Remark: Generated from `#/paths/secret-scanning-alert-location-created/POST/header`.
            public struct Headers: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/secret-scanning-alert-location-created/POST/header/User-Agent`.
                public var userAgent: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-location-created/POST/header/X-Github-Hook-Id`.
                public var xGithubHookId: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-location-created/POST/header/X-Github-Event`.
                public var xGithubEvent: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-location-created/POST/header/X-Github-Hook-Installation-Target-Id`.
                public var xGithubHookInstallationTargetId: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-location-created/POST/header/X-Github-Hook-Installation-Target-Type`.
                public var xGithubHookInstallationTargetType: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-location-created/POST/header/X-GitHub-Delivery`.
                public var xGitHubDelivery: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-location-created/POST/header/X-Hub-Signature-256`.
                public var xHubSignature256: Swift.String?
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
            ...
            public var headers: Operations.SecretScanningAlertLocationCreated.Input.Headers
            /// - Remark: Generated from `#/paths/secret-scanning-alert-location-created/POST/requestBody`.
            @frozen public enum Body: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/secret-scanning-alert-location-created/POST/requestBody/content/application\/json`.
                case json(Components.Schemas.WebhookSecretScanningAlertLocationCreated)
                /// - Remark: Generated from `#/paths/secret-scanning-alert-location-created/POST/requestBody/content/application\/x-www-form-urlencoded`.
                case urlEncodedForm(Components.Schemas.WebhookSecretScanningAlertLocationCreatedFormEncoded)
            }
            public var body: Operations.SecretScanningAlertLocationCreated.Input.Body
            /// Creates a new `Input`.
            ///
            /// - Parameters:
            ///   - headers:
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//secret-scanning-alert-location-created/post(secret-scanning-alert-location/created)/responses/200`.
            ///
            /// HTTP response code: `200 ok`.
            case ok(Operations.SecretScanningAlertLocationCreated.Output.Ok)
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//secret-scanning-alert-location-created/post(secret-scanning-alert-location/created)/responses/200`.
            ///
            ...
            /// - Throws: An error if `self` is not `.ok`.
            /// - SeeAlso: `.ok`.
            public var ok: Operations.SecretScanningAlertLocationCreated.Output.Ok {
                get throws {
                    switch self {
                    case let .ok(response):
                        return response
    ...
    /// - Remark: HTTP `POST /secret-scanning-alert-reopened`.
    /// - Remark: Generated from `#/paths//secret-scanning-alert-reopened/post(secret-scanning-alert/reopened)`.
    public enum SecretScanningAlertReopened {
        public static let id: Swift.String = "secret-scanning-alert/reopened"
        public struct Input: Sendable, Hashable {
            /// - Remark: Generated from `#/paths/secret-scanning-alert-reopened/POST/header`.
            public struct Headers: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/secret-scanning-alert-reopened/POST/header/User-Agent`.
                public var userAgent: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-reopened/POST/header/X-Github-Hook-Id`.
                public var xGithubHookId: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-reopened/POST/header/X-Github-Event`.
                public var xGithubEvent: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-reopened/POST/header/X-Github-Hook-Installation-Target-Id`.
                public var xGithubHookInstallationTargetId: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-reopened/POST/header/X-Github-Hook-Installation-Target-Type`.
                public var xGithubHookInstallationTargetType: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-reopened/POST/header/X-GitHub-Delivery`.
                public var xGitHubDelivery: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-reopened/POST/header/X-Hub-Signature-256`.
                public var xHubSignature256: Swift.String?
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
            ...
            public var headers: Operations.SecretScanningAlertReopened.Input.Headers
            /// - Remark: Generated from `#/paths/secret-scanning-alert-reopened/POST/requestBody`.
            @frozen public enum Body: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/secret-scanning-alert-reopened/POST/requestBody/content/application\/json`.
                case json(Components.Schemas.WebhookSecretScanningAlertReopened)
            }
            public var body: Operations.SecretScanningAlertReopened.Input.Body
            /// Creates a new `Input`.
            ///
            /// - Parameters:
            ///   - headers:
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//secret-scanning-alert-reopened/post(secret-scanning-alert/reopened)/responses/200`.
            ///
            /// HTTP response code: `200 ok`.
            case ok(Operations.SecretScanningAlertReopened.Output.Ok)
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//secret-scanning-alert-reopened/post(secret-scanning-alert/reopened)/responses/200`.
            ///
            ...
            /// - Throws: An error if `self` is not `.ok`.
            /// - SeeAlso: `.ok`.
            public var ok: Operations.SecretScanningAlertReopened.Output.Ok {
                get throws {
                    switch self {
                    case let .ok(response):
                        return response
    ...
    /// - Remark: HTTP `POST /secret-scanning-alert-resolved`.
    /// - Remark: Generated from `#/paths//secret-scanning-alert-resolved/post(secret-scanning-alert/resolved)`.
    public enum SecretScanningAlertResolved {
        public static let id: Swift.String = "secret-scanning-alert/resolved"
        public struct Input: Sendable, Hashable {
            /// - Remark: Generated from `#/paths/secret-scanning-alert-resolved/POST/header`.
            public struct Headers: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/secret-scanning-alert-resolved/POST/header/User-Agent`.
                public var userAgent: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-resolved/POST/header/X-Github-Hook-Id`.
                public var xGithubHookId: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-resolved/POST/header/X-Github-Event`.
                public var xGithubEvent: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-resolved/POST/header/X-Github-Hook-Installation-Target-Id`.
                public var xGithubHookInstallationTargetId: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-resolved/POST/header/X-Github-Hook-Installation-Target-Type`.
                public var xGithubHookInstallationTargetType: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-resolved/POST/header/X-GitHub-Delivery`.
                public var xGitHubDelivery: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-resolved/POST/header/X-Hub-Signature-256`.
                public var xHubSignature256: Swift.String?
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
            ...
            public var headers: Operations.SecretScanningAlertResolved.Input.Headers
            /// - Remark: Generated from `#/paths/secret-scanning-alert-resolved/POST/requestBody`.
            @frozen public enum Body: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/secret-scanning-alert-resolved/POST/requestBody/content/application\/json`.
                case json(Components.Schemas.WebhookSecretScanningAlertResolved)
            }
            public var body: Operations.SecretScanningAlertResolved.Input.Body
            /// Creates a new `Input`.
            ///
            /// - Parameters:
            ///   - headers:
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//secret-scanning-alert-resolved/post(secret-scanning-alert/resolved)/responses/200`.
            ///
            /// HTTP response code: `200 ok`.
            case ok(Operations.SecretScanningAlertResolved.Output.Ok)
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//secret-scanning-alert-resolved/post(secret-scanning-alert/resolved)/responses/200`.
            ///
            ...
            /// - Throws: An error if `self` is not `.ok`.
            /// - SeeAlso: `.ok`.
            public var ok: Operations.SecretScanningAlertResolved.Output.Ok {
                get throws {
                    switch self {
                    case let .ok(response):
                        return response
    ...
    /// - Remark: HTTP `POST /secret-scanning-alert-revoked`.
    /// - Remark: Generated from `#/paths//secret-scanning-alert-revoked/post(secret-scanning-alert/revoked)`.
    public enum SecretScanningAlertRevoked {
        public static let id: Swift.String = "secret-scanning-alert/revoked"
        public struct Input: Sendable, Hashable {
            /// - Remark: Generated from `#/paths/secret-scanning-alert-revoked/POST/header`.
            public struct Headers: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/secret-scanning-alert-revoked/POST/header/User-Agent`.
                public var userAgent: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-revoked/POST/header/X-Github-Hook-Id`.
                public var xGithubHookId: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-revoked/POST/header/X-Github-Event`.
                public var xGithubEvent: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-revoked/POST/header/X-Github-Hook-Installation-Target-Id`.
                public var xGithubHookInstallationTargetId: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-revoked/POST/header/X-Github-Hook-Installation-Target-Type`.
                public var xGithubHookInstallationTargetType: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-revoked/POST/header/X-GitHub-Delivery`.
                public var xGitHubDelivery: Swift.String?
                /// - Remark: Generated from `#/paths/secret-scanning-alert-revoked/POST/header/X-Hub-Signature-256`.
                public var xHubSignature256: Swift.String?
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
            ...
            public var headers: Operations.SecretScanningAlertRevoked.Input.Headers
            /// - Remark: Generated from `#/paths/secret-scanning-alert-revoked/POST/requestBody`.
            @frozen public enum Body: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/secret-scanning-alert-revoked/POST/requestBody/content/application\/json`.
                case json(Components.Schemas.WebhookSecretScanningAlertRevoked)
            }
            public var body: Operations.SecretScanningAlertRevoked.Input.Body
            /// Creates a new `Input`.
            ///
            /// - Parameters:
            ///   - headers:
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//secret-scanning-alert-revoked/post(secret-scanning-alert/revoked)/responses/200`.
            ///
            /// HTTP response code: `200 ok`.
            case ok(Operations.SecretScanningAlertRevoked.Output.Ok)
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//secret-scanning-alert-revoked/post(secret-scanning-alert/revoked)/responses/200`.
            ///
            ...
            /// - Throws: An error if `self` is not `.ok`.
            /// - SeeAlso: `.ok`.
            public var ok: Operations.SecretScanningAlertRevoked.Output.Ok {
                get throws {
                    switch self {
                    case let .ok(response):
                        return response
