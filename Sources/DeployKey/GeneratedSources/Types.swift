...
public protocol APIProtocol: Sendable {
    /// Deploy key created
    ///
    /// - Remark: HTTP `POST /deploy-key-created`.
    /// - Remark: Generated from `#/paths//deploy-key-created/post(deploy-key/created)`.
    func deployKeyCreated(_ input: Operations.DeployKeyCreated.Input) async throws -> Operations.DeployKeyCreated.Output
    /// Deploy key deleted
    ///
    /// - Remark: HTTP `POST /deploy-key-deleted`.
    /// - Remark: Generated from `#/paths//deploy-key-deleted/post(deploy-key/deleted)`.
    func deployKeyDeleted(_ input: Operations.DeployKeyDeleted.Input) async throws -> Operations.DeployKeyDeleted.Output
}
...
extension APIProtocol {
    ...
    /// - Remark: HTTP `POST /deploy-key-created`.
    /// - Remark: Generated from `#/paths//deploy-key-created/post(deploy-key/created)`.
    public func deployKeyCreated(
        headers: Operations.DeployKeyCreated.Input.Headers = .init(),
        body: Operations.DeployKeyCreated.Input.Body
    ) async throws -> Operations.DeployKeyCreated.Output {
        try await deployKeyCreated(Operations.DeployKeyCreated.Input(
            headers: headers,
            body: body
        ))
    }
    ...
    /// - Remark: HTTP `POST /deploy-key-deleted`.
    /// - Remark: Generated from `#/paths//deploy-key-deleted/post(deploy-key/deleted)`.
    public func deployKeyDeleted(
        headers: Operations.DeployKeyDeleted.Input.Headers = .init(),
        body: Operations.DeployKeyDeleted.Input.Body
    ) async throws -> Operations.DeployKeyDeleted.Output {
        try await deployKeyDeleted(Operations.DeployKeyDeleted.Input(
            headers: headers,
            body: body
        ))
    }
...
public enum Components {
    ...
    public enum Schemas {
        ...
        /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-created`.
        public struct WebhookDeployKeyCreated: Codable, Hashable, Sendable {
            /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-created/action`.
            @frozen public enum ActionPayload: String, Codable, Hashable, Sendable, CaseIterable {
                case created = "created"
            }
            /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-created/action`.
            public var action: Components.Schemas.WebhookDeployKeyCreated.ActionPayload
            /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-created/enterprise`.
            public var enterprise: Components.Schemas.Enterprise?
            /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-created/installation`.
            ...
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-created/key`.
            public struct KeyPayload: Codable, Hashable, Sendable {
                /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-created/key/added_by`.
                public var addedBy: Swift.String?
                /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-created/key/created_at`.
                public var createdAt: Swift.String
                /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-created/key/id`.
                public var id: Swift.Int
                /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-created/key/key`.
                public var key: Swift.String
                /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-created/key/last_used`.
                public var lastUsed: Swift.String?
                /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-created/key/read_only`.
                public var readOnly: Swift.Bool
                /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-created/key/title`.
                public var title: Swift.String
                /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-created/key/url`.
                public var url: Swift.String
                /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-created/key/verified`.
            ...
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-created/key`.
            public var key: Components.Schemas.WebhookDeployKeyCreated.KeyPayload
            /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-created/organization`.
            public var organization: Components.Schemas.OrganizationSimple?
            /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-created/repository`.
            public var repository: Components.Schemas.Repository
            /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-created/sender`.
            public var sender: Components.Schemas.SimpleUser
            /// Creates a new `WebhookDeployKeyCreated`.
            ///
            /// - Parameters:
            ///   - action:
            ///   - enterprise:
            ///   - installation:
            ///   - key: The [`deploy key`](https://docs.github.com/en/rest/reference/deployments#get-a-deploy-key) resource.
            ///   - organization:
            ///   - repository:
            ///   - sender:
            public init(
                action: Components.Schemas.WebhookDeployKeyCreated.ActionPayload,
                enterprise: Components.Schemas.Enterprise? = nil,
                installation: Components.Schemas.SimpleInstallation? = nil,
                key: Components.Schemas.WebhookDeployKeyCreated.KeyPayload,
        ...
        /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-deleted`.
        public struct WebhookDeployKeyDeleted: Codable, Hashable, Sendable {
            /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-deleted/action`.
            @frozen public enum ActionPayload: String, Codable, Hashable, Sendable, CaseIterable {
                case deleted = "deleted"
            }
            /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-deleted/action`.
            public var action: Components.Schemas.WebhookDeployKeyDeleted.ActionPayload
            /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-deleted/enterprise`.
            public var enterprise: Components.Schemas.Enterprise?
            /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-deleted/installation`.
            public var installation: Components.Schemas.SimpleInstallation?
            /// The [`deploy key`](https://docs.github.com/en/rest/reference/deployments#get-a-deploy-key) resource.
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-deleted/key`.
            public struct KeyPayload: Codable, Hashable, Sendable {
                /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-deleted/key/added_by`.
                public var addedBy: Swift.String?
                /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-deleted/key/created_at`.
                public var createdAt: Swift.String
                /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-deleted/key/id`.
                public var id: Swift.Int
                /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-deleted/key/key`.
                public var key: Swift.String
                /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-deleted/key/last_used`.
                public var lastUsed: Swift.String?
                /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-deleted/key/read_only`.
                public var readOnly: Swift.Bool
                /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-deleted/key/title`.
                public var title: Swift.String
                /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-deleted/key/url`.
                public var url: Swift.String
                /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-deleted/key/verified`.
                public var verified: Swift.Bool
                /// Creates a new `KeyPayload`.
                ///
                /// - Parameters:
            ...
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-deleted/key`.
            public var key: Components.Schemas.WebhookDeployKeyDeleted.KeyPayload
            /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-deleted/organization`.
            public var organization: Components.Schemas.OrganizationSimple?
            /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-deleted/repository`.
            public var repository: Components.Schemas.Repository
            /// - Remark: Generated from `#/components/schemas/webhook-deploy-key-deleted/sender`.
            public var sender: Components.Schemas.SimpleUser
            /// Creates a new `WebhookDeployKeyDeleted`.
            ///
            /// - Parameters:
            ///   - action:
            ///   - enterprise:
            ...
            ///   - sender:
            public init(
                action: Components.Schemas.WebhookDeployKeyDeleted.ActionPayload,
                enterprise: Components.Schemas.Enterprise? = nil,
                installation: Components.Schemas.SimpleInstallation? = nil,
                key: Components.Schemas.WebhookDeployKeyDeleted.KeyPayload,
                organization: Components.Schemas.OrganizationSimple? = nil,
                repository: Components.Schemas.Repository,
                sender: Components.Schemas.SimpleUser
            ) {
...
public enum Operations {
    ...
    /// - Remark: HTTP `POST /deploy-key-created`.
    /// - Remark: Generated from `#/paths//deploy-key-created/post(deploy-key/created)`.
    public enum DeployKeyCreated {
        public static let id: Swift.String = "deploy-key/created"
        public struct Input: Sendable, Hashable {
            /// - Remark: Generated from `#/paths/deploy-key-created/POST/header`.
            public struct Headers: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/deploy-key-created/POST/header/User-Agent`.
                public var userAgent: Swift.String?
                /// - Remark: Generated from `#/paths/deploy-key-created/POST/header/X-Github-Hook-Id`.
                public var xGithubHookId: Swift.String?
                /// - Remark: Generated from `#/paths/deploy-key-created/POST/header/X-Github-Event`.
                public var xGithubEvent: Swift.String?
                /// - Remark: Generated from `#/paths/deploy-key-created/POST/header/X-Github-Hook-Installation-Target-Id`.
                public var xGithubHookInstallationTargetId: Swift.String?
                /// - Remark: Generated from `#/paths/deploy-key-created/POST/header/X-Github-Hook-Installation-Target-Type`.
                public var xGithubHookInstallationTargetType: Swift.String?
                /// - Remark: Generated from `#/paths/deploy-key-created/POST/header/X-GitHub-Delivery`.
                public var xGitHubDelivery: Swift.String?
                /// - Remark: Generated from `#/paths/deploy-key-created/POST/header/X-Hub-Signature-256`.
            ...
            public var headers: Operations.DeployKeyCreated.Input.Headers
            /// - Remark: Generated from `#/paths/deploy-key-created/POST/requestBody`.
            @frozen public enum Body: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/deploy-key-created/POST/requestBody/content/application\/json`.
                case json(Components.Schemas.WebhookDeployKeyCreated)
            }
            public var body: Operations.DeployKeyCreated.Input.Body
            /// Creates a new `Input`.
            ///
            /// - Parameters:
            ///   - headers:
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            ///
            /// - Remark: Generated from `#/paths//deploy-key-created/post(deploy-key/created)/responses/200`.
            ///
            /// HTTP response code: `200 ok`.
            case ok(Operations.DeployKeyCreated.Output.Ok)
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//deploy-key-created/post(deploy-key/created)/responses/200`.
            ///
            ...
            /// - SeeAlso: `.ok`.
            public var ok: Operations.DeployKeyCreated.Output.Ok {
                get throws {
                    switch self {
    ...
    /// - Remark: HTTP `POST /deploy-key-deleted`.
    /// - Remark: Generated from `#/paths//deploy-key-deleted/post(deploy-key/deleted)`.
    public enum DeployKeyDeleted {
        public static let id: Swift.String = "deploy-key/deleted"
        public struct Input: Sendable, Hashable {
            /// - Remark: Generated from `#/paths/deploy-key-deleted/POST/header`.
            public struct Headers: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/deploy-key-deleted/POST/header/User-Agent`.
                public var userAgent: Swift.String?
                /// - Remark: Generated from `#/paths/deploy-key-deleted/POST/header/X-Github-Hook-Id`.
                public var xGithubHookId: Swift.String?
                /// - Remark: Generated from `#/paths/deploy-key-deleted/POST/header/X-Github-Event`.
                public var xGithubEvent: Swift.String?
                /// - Remark: Generated from `#/paths/deploy-key-deleted/POST/header/X-Github-Hook-Installation-Target-Id`.
                public var xGithubHookInstallationTargetId: Swift.String?
                /// - Remark: Generated from `#/paths/deploy-key-deleted/POST/header/X-Github-Hook-Installation-Target-Type`.
                public var xGithubHookInstallationTargetType: Swift.String?
                /// - Remark: Generated from `#/paths/deploy-key-deleted/POST/header/X-GitHub-Delivery`.
                public var xGitHubDelivery: Swift.String?
                /// - Remark: Generated from `#/paths/deploy-key-deleted/POST/header/X-Hub-Signature-256`.
                public var xHubSignature256: Swift.String?
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
            ...
            public var headers: Operations.DeployKeyDeleted.Input.Headers
            /// - Remark: Generated from `#/paths/deploy-key-deleted/POST/requestBody`.
            @frozen public enum Body: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/deploy-key-deleted/POST/requestBody/content/application\/json`.
                case json(Components.Schemas.WebhookDeployKeyDeleted)
            }
            public var body: Operations.DeployKeyDeleted.Input.Body
            /// Creates a new `Input`.
            ///
            /// - Parameters:
            ///   - headers:
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//deploy-key-deleted/post(deploy-key/deleted)/responses/200`.
            ///
            /// HTTP response code: `200 ok`.
            case ok(Operations.DeployKeyDeleted.Output.Ok)
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//deploy-key-deleted/post(deploy-key/deleted)/responses/200`.
            ///
            ...
            /// - Throws: An error if `self` is not `.ok`.
            /// - SeeAlso: `.ok`.
            public var ok: Operations.DeployKeyDeleted.Output.Ok {
                get throws {
                    switch self {
                    case let .ok(response):
                        return response
