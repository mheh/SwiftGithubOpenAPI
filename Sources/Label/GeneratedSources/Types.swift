...
public protocol APIProtocol: Sendable {
    ...
    /// A label was created.
    ///
    /// - Remark: HTTP `POST /label-created`.
    /// - Remark: Generated from `#/paths//label-created/post(label/created)`.
    func labelCreated(_ input: Operations.LabelCreated.Input) async throws -> Operations.LabelCreated.Output
    /// This event occurs when there is activity relating to labels. For more information, see "[Managing labels](https://docs.github.com/issues/using-labels-and-milestones-to-track-work/managing-labels)." For information about the Label APIs, see [the GraphQL documentation](https://docs.github.com/graphql/reference/objects#label) and [the REST API documentation](https://docs.github.com/rest/issues/labels).
    ///
    /// If you want to receive an event when a label is added to or removed from an issue, pull request, or discussion, use the `labeled` or `unlabeled` action type for the `issues`, `pull_request`, or `discussion` events instead.
    ///
    ...
    /// A label was deleted.
    ///
    /// - Remark: HTTP `POST /label-deleted`.
    /// - Remark: Generated from `#/paths//label-deleted/post(label/deleted)`.
    func labelDeleted(_ input: Operations.LabelDeleted.Input) async throws -> Operations.LabelDeleted.Output
    /// This event occurs when there is activity relating to labels. For more information, see "[Managing labels](https://docs.github.com/issues/using-labels-and-milestones-to-track-work/managing-labels)." For information about the Label APIs, see [the GraphQL documentation](https://docs.github.com/graphql/reference/objects#label) and [the REST API documentation](https://docs.github.com/rest/issues/labels).
    ///
    /// If you want to receive an event when a label is added to or removed from an issue, pull request, or discussion, use the `labeled` or `unlabeled` action type for the `issues`, `pull_request`, or `discussion` events instead.
    ///
    ...
    ///
    /// - Remark: HTTP `POST /label-edited`.
    /// - Remark: Generated from `#/paths//label-edited/post(label/edited)`.
    func labelEdited(_ input: Operations.LabelEdited.Input) async throws -> Operations.LabelEdited.Output
}
...
extension APIProtocol {
    ...
    /// - Remark: HTTP `POST /label-created`.
    /// - Remark: Generated from `#/paths//label-created/post(label/created)`.
    public func labelCreated(
        headers: Operations.LabelCreated.Input.Headers = .init(),
        body: Operations.LabelCreated.Input.Body
    ) async throws -> Operations.LabelCreated.Output {
        try await labelCreated(Operations.LabelCreated.Input(
            headers: headers,
            body: body
        ))
    }
    ...
    /// - Remark: HTTP `POST /label-deleted`.
    /// - Remark: Generated from `#/paths//label-deleted/post(label/deleted)`.
    public func labelDeleted(
        headers: Operations.LabelDeleted.Input.Headers = .init(),
        body: Operations.LabelDeleted.Input.Body
    ) async throws -> Operations.LabelDeleted.Output {
        try await labelDeleted(Operations.LabelDeleted.Input(
            headers: headers,
            body: body
        ))
    }
    ...
    /// - Remark: HTTP `POST /label-edited`.
    /// - Remark: Generated from `#/paths//label-edited/post(label/edited)`.
    public func labelEdited(
        headers: Operations.LabelEdited.Input.Headers = .init(),
        body: Operations.LabelEdited.Input.Body
    ) async throws -> Operations.LabelEdited.Output {
        try await labelEdited(Operations.LabelEdited.Input(
            headers: headers,
            body: body
        ))
    }
...
public enum Components {
    ...
    public enum Schemas {
        ...
        /// - Remark: Generated from `#/components/schemas/webhook-label-created`.
        public struct WebhookLabelCreated: Codable, Hashable, Sendable {
            /// - Remark: Generated from `#/components/schemas/webhook-label-created/action`.
            @frozen public enum ActionPayload: String, Codable, Hashable, Sendable, CaseIterable {
                case created = "created"
            }
            /// - Remark: Generated from `#/components/schemas/webhook-label-created/action`.
            public var action: Components.Schemas.WebhookLabelCreated.ActionPayload
            /// - Remark: Generated from `#/components/schemas/webhook-label-created/enterprise`.
            public var enterprise: Components.Schemas.Enterprise?
            /// - Remark: Generated from `#/components/schemas/webhook-label-created/installation`.
            public var installation: Components.Schemas.SimpleInstallation?
            /// - Remark: Generated from `#/components/schemas/webhook-label-created/label`.
            public struct LabelPayload: Codable, Hashable, Sendable {
                /// 6-character hex code, without the leading #, identifying the color
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-label-created/label/color`.
                public var color: Swift.String
                /// - Remark: Generated from `#/components/schemas/webhook-label-created/label/default`.
                public var _default: Swift.Bool
                /// - Remark: Generated from `#/components/schemas/webhook-label-created/label/description`.
                public var description: Swift.String?
                /// - Remark: Generated from `#/components/schemas/webhook-label-created/label/id`.
                public var id: Swift.Int
                /// The name of the label.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-label-created/label/name`.
                public var name: Swift.String
                /// - Remark: Generated from `#/components/schemas/webhook-label-created/label/node_id`.
                public var nodeId: Swift.String
                /// URL for the label
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-label-created/label/url`.
                public var url: Swift.String
            ...
            /// - Remark: Generated from `#/components/schemas/webhook-label-created/label`.
            public var label: Components.Schemas.WebhookLabelCreated.LabelPayload
            /// - Remark: Generated from `#/components/schemas/webhook-label-created/organization`.
            public var organization: Components.Schemas.OrganizationSimple?
            /// - Remark: Generated from `#/components/schemas/webhook-label-created/repository`.
            public var repository: Components.Schemas.Repository
            /// - Remark: Generated from `#/components/schemas/webhook-label-created/sender`.
            public var sender: Components.Schemas.SimpleUser?
            /// Creates a new `WebhookLabelCreated`.
            ///
            /// - Parameters:
            ///   - action:
            ///   - enterprise:
            ...
            ///   - sender:
            public init(
                action: Components.Schemas.WebhookLabelCreated.ActionPayload,
                enterprise: Components.Schemas.Enterprise? = nil,
                installation: Components.Schemas.SimpleInstallation? = nil,
                label: Components.Schemas.WebhookLabelCreated.LabelPayload,
        ...
        /// - Remark: Generated from `#/components/schemas/webhook-label-deleted`.
        public struct WebhookLabelDeleted: Codable, Hashable, Sendable {
            /// - Remark: Generated from `#/components/schemas/webhook-label-deleted/action`.
            @frozen public enum ActionPayload: String, Codable, Hashable, Sendable, CaseIterable {
                case deleted = "deleted"
            }
            /// - Remark: Generated from `#/components/schemas/webhook-label-deleted/action`.
            public var action: Components.Schemas.WebhookLabelDeleted.ActionPayload
            /// - Remark: Generated from `#/components/schemas/webhook-label-deleted/enterprise`.
            public var enterprise: Components.Schemas.Enterprise?
            /// - Remark: Generated from `#/components/schemas/webhook-label-deleted/installation`.
            public var installation: Components.Schemas.SimpleInstallation?
            /// - Remark: Generated from `#/components/schemas/webhook-label-deleted/label`.
            public struct LabelPayload: Codable, Hashable, Sendable {
                /// 6-character hex code, without the leading #, identifying the color
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-label-deleted/label/color`.
                public var color: Swift.String
                /// - Remark: Generated from `#/components/schemas/webhook-label-deleted/label/default`.
                public var _default: Swift.Bool
                /// - Remark: Generated from `#/components/schemas/webhook-label-deleted/label/description`.
                public var description: Swift.String?
                /// - Remark: Generated from `#/components/schemas/webhook-label-deleted/label/id`.
                public var id: Swift.Int
                /// The name of the label.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-label-deleted/label/name`.
                public var name: Swift.String
                /// - Remark: Generated from `#/components/schemas/webhook-label-deleted/label/node_id`.
                public var nodeId: Swift.String
                /// URL for the label
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-label-deleted/label/url`.
                public var url: Swift.String
                /// Creates a new `LabelPayload`.
                ///
                /// - Parameters:
            ...
            /// - Remark: Generated from `#/components/schemas/webhook-label-deleted/label`.
            public var label: Components.Schemas.WebhookLabelDeleted.LabelPayload
            /// - Remark: Generated from `#/components/schemas/webhook-label-deleted/organization`.
            public var organization: Components.Schemas.OrganizationSimple?
            /// - Remark: Generated from `#/components/schemas/webhook-label-deleted/repository`.
            public var repository: Components.Schemas.Repository
            /// - Remark: Generated from `#/components/schemas/webhook-label-deleted/sender`.
            public var sender: Components.Schemas.SimpleUser
            /// Creates a new `WebhookLabelDeleted`.
            ///
            /// - Parameters:
            ///   - action:
            ///   - enterprise:
            ...
            ///   - sender:
            public init(
                action: Components.Schemas.WebhookLabelDeleted.ActionPayload,
                enterprise: Components.Schemas.Enterprise? = nil,
                installation: Components.Schemas.SimpleInstallation? = nil,
                label: Components.Schemas.WebhookLabelDeleted.LabelPayload,
                organization: Components.Schemas.OrganizationSimple? = nil,
                repository: Components.Schemas.Repository,
        ...
        /// - Remark: Generated from `#/components/schemas/webhook-label-edited`.
        public struct WebhookLabelEdited: Codable, Hashable, Sendable {
            /// - Remark: Generated from `#/components/schemas/webhook-label-edited/action`.
            @frozen public enum ActionPayload: String, Codable, Hashable, Sendable, CaseIterable {
                case edited = "edited"
            }
            /// - Remark: Generated from `#/components/schemas/webhook-label-edited/action`.
            public var action: Components.Schemas.WebhookLabelEdited.ActionPayload
            /// The changes to the label if the action was `edited`.
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-label-edited/changes`.
            public struct ChangesPayload: Codable, Hashable, Sendable {
                /// - Remark: Generated from `#/components/schemas/webhook-label-edited/changes/color`.
                public struct ColorPayload: Codable, Hashable, Sendable {
                    /// The previous version of the color if the action was `edited`.
                    ///
                    /// - Remark: Generated from `#/components/schemas/webhook-label-edited/changes/color/from`.
                ...
                /// - Remark: Generated from `#/components/schemas/webhook-label-edited/changes/color`.
                public var color: Components.Schemas.WebhookLabelEdited.ChangesPayload.ColorPayload?
                /// - Remark: Generated from `#/components/schemas/webhook-label-edited/changes/description`.
                public struct DescriptionPayload: Codable, Hashable, Sendable {
                    /// The previous version of the description if the action was `edited`.
                    ///
                    /// - Remark: Generated from `#/components/schemas/webhook-label-edited/changes/description/from`.
                    public var from: Swift.String
                ...
                /// - Remark: Generated from `#/components/schemas/webhook-label-edited/changes/description`.
                public var description: Components.Schemas.WebhookLabelEdited.ChangesPayload.DescriptionPayload?
                /// - Remark: Generated from `#/components/schemas/webhook-label-edited/changes/name`.
                public struct NamePayload: Codable, Hashable, Sendable {
                    /// The previous version of the name if the action was `edited`.
                    ///
                    /// - Remark: Generated from `#/components/schemas/webhook-label-edited/changes/name/from`.
                    public var from: Swift.String
                ...
                /// - Remark: Generated from `#/components/schemas/webhook-label-edited/changes/name`.
                public var name: Components.Schemas.WebhookLabelEdited.ChangesPayload.NamePayload?
                ...
                ///   - name:
                public init(
                    color: Components.Schemas.WebhookLabelEdited.ChangesPayload.ColorPayload? = nil,
                    description: Components.Schemas.WebhookLabelEdited.ChangesPayload.DescriptionPayload? = nil,
                    name: Components.Schemas.WebhookLabelEdited.ChangesPayload.NamePayload? = nil
                ) {
                    self.color = color
                    self.description = description
                    self.name = name
            ...
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-label-edited/changes`.
            public var changes: Components.Schemas.WebhookLabelEdited.ChangesPayload?
            /// - Remark: Generated from `#/components/schemas/webhook-label-edited/enterprise`.
            public var enterprise: Components.Schemas.Enterprise?
            /// - Remark: Generated from `#/components/schemas/webhook-label-edited/installation`.
            public var installation: Components.Schemas.SimpleInstallation?
            /// - Remark: Generated from `#/components/schemas/webhook-label-edited/label`.
            public struct LabelPayload: Codable, Hashable, Sendable {
                /// 6-character hex code, without the leading #, identifying the color
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-label-edited/label/color`.
                public var color: Swift.String
                /// - Remark: Generated from `#/components/schemas/webhook-label-edited/label/default`.
                public var _default: Swift.Bool
                /// - Remark: Generated from `#/components/schemas/webhook-label-edited/label/description`.
                public var description: Swift.String?
                /// - Remark: Generated from `#/components/schemas/webhook-label-edited/label/id`.
                public var id: Swift.Int
                /// The name of the label.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-label-edited/label/name`.
                public var name: Swift.String
                /// - Remark: Generated from `#/components/schemas/webhook-label-edited/label/node_id`.
                public var nodeId: Swift.String
                /// URL for the label
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-label-edited/label/url`.
                public var url: Swift.String
                /// Creates a new `LabelPayload`.
                ///
                /// - Parameters:
            ...
            /// - Remark: Generated from `#/components/schemas/webhook-label-edited/label`.
            public var label: Components.Schemas.WebhookLabelEdited.LabelPayload
            /// - Remark: Generated from `#/components/schemas/webhook-label-edited/organization`.
            public var organization: Components.Schemas.OrganizationSimple?
            /// - Remark: Generated from `#/components/schemas/webhook-label-edited/repository`.
            public var repository: Components.Schemas.Repository
            /// - Remark: Generated from `#/components/schemas/webhook-label-edited/sender`.
            public var sender: Components.Schemas.SimpleUser
            /// Creates a new `WebhookLabelEdited`.
            ///
            /// - Parameters:
            ///   - action:
            ...
            ///   - sender:
            public init(
                action: Components.Schemas.WebhookLabelEdited.ActionPayload,
                changes: Components.Schemas.WebhookLabelEdited.ChangesPayload? = nil,
                enterprise: Components.Schemas.Enterprise? = nil,
                installation: Components.Schemas.SimpleInstallation? = nil,
                label: Components.Schemas.WebhookLabelEdited.LabelPayload,
                organization: Components.Schemas.OrganizationSimple? = nil,
                repository: Components.Schemas.Repository,
                sender: Components.Schemas.SimpleUser
            ) {
...
public enum Operations {
    ...
    /// - Remark: HTTP `POST /label-created`.
    /// - Remark: Generated from `#/paths//label-created/post(label/created)`.
    public enum LabelCreated {
        public static let id: Swift.String = "label/created"
        public struct Input: Sendable, Hashable {
            /// - Remark: Generated from `#/paths/label-created/POST/header`.
            public struct Headers: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/label-created/POST/header/User-Agent`.
                public var userAgent: Swift.String?
                /// - Remark: Generated from `#/paths/label-created/POST/header/X-Github-Hook-Id`.
                public var xGithubHookId: Swift.String?
                /// - Remark: Generated from `#/paths/label-created/POST/header/X-Github-Event`.
                public var xGithubEvent: Swift.String?
                /// - Remark: Generated from `#/paths/label-created/POST/header/X-Github-Hook-Installation-Target-Id`.
                public var xGithubHookInstallationTargetId: Swift.String?
                /// - Remark: Generated from `#/paths/label-created/POST/header/X-Github-Hook-Installation-Target-Type`.
                public var xGithubHookInstallationTargetType: Swift.String?
                /// - Remark: Generated from `#/paths/label-created/POST/header/X-GitHub-Delivery`.
                public var xGitHubDelivery: Swift.String?
                /// - Remark: Generated from `#/paths/label-created/POST/header/X-Hub-Signature-256`.
            ...
            public var headers: Operations.LabelCreated.Input.Headers
            /// - Remark: Generated from `#/paths/label-created/POST/requestBody`.
            @frozen public enum Body: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/label-created/POST/requestBody/content/application\/json`.
                case json(Components.Schemas.WebhookLabelCreated)
            }
            public var body: Operations.LabelCreated.Input.Body
            /// Creates a new `Input`.
            ///
            /// - Parameters:
            ///   - headers:
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            ///
            /// - Remark: Generated from `#/paths//label-created/post(label/created)/responses/200`.
            ///
            /// HTTP response code: `200 ok`.
            case ok(Operations.LabelCreated.Output.Ok)
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//label-created/post(label/created)/responses/200`.
            ///
            ...
            /// - SeeAlso: `.ok`.
            public var ok: Operations.LabelCreated.Output.Ok {
                get throws {
                    switch self {
    ...
    /// - Remark: HTTP `POST /label-deleted`.
    /// - Remark: Generated from `#/paths//label-deleted/post(label/deleted)`.
    public enum LabelDeleted {
        public static let id: Swift.String = "label/deleted"
        public struct Input: Sendable, Hashable {
            /// - Remark: Generated from `#/paths/label-deleted/POST/header`.
            public struct Headers: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/label-deleted/POST/header/User-Agent`.
                public var userAgent: Swift.String?
                /// - Remark: Generated from `#/paths/label-deleted/POST/header/X-Github-Hook-Id`.
                public var xGithubHookId: Swift.String?
                /// - Remark: Generated from `#/paths/label-deleted/POST/header/X-Github-Event`.
                public var xGithubEvent: Swift.String?
                /// - Remark: Generated from `#/paths/label-deleted/POST/header/X-Github-Hook-Installation-Target-Id`.
                public var xGithubHookInstallationTargetId: Swift.String?
                /// - Remark: Generated from `#/paths/label-deleted/POST/header/X-Github-Hook-Installation-Target-Type`.
                public var xGithubHookInstallationTargetType: Swift.String?
                /// - Remark: Generated from `#/paths/label-deleted/POST/header/X-GitHub-Delivery`.
                public var xGitHubDelivery: Swift.String?
                /// - Remark: Generated from `#/paths/label-deleted/POST/header/X-Hub-Signature-256`.
                public var xHubSignature256: Swift.String?
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
            ...
            public var headers: Operations.LabelDeleted.Input.Headers
            /// - Remark: Generated from `#/paths/label-deleted/POST/requestBody`.
            @frozen public enum Body: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/label-deleted/POST/requestBody/content/application\/json`.
                case json(Components.Schemas.WebhookLabelDeleted)
            }
            public var body: Operations.LabelDeleted.Input.Body
            /// Creates a new `Input`.
            ///
            /// - Parameters:
            ///   - headers:
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//label-deleted/post(label/deleted)/responses/200`.
            ///
            /// HTTP response code: `200 ok`.
            case ok(Operations.LabelDeleted.Output.Ok)
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//label-deleted/post(label/deleted)/responses/200`.
            ///
            ...
            /// - Throws: An error if `self` is not `.ok`.
            /// - SeeAlso: `.ok`.
            public var ok: Operations.LabelDeleted.Output.Ok {
                get throws {
                    switch self {
                    case let .ok(response):
                        return response
    ...
    /// - Remark: HTTP `POST /label-edited`.
    /// - Remark: Generated from `#/paths//label-edited/post(label/edited)`.
    public enum LabelEdited {
        public static let id: Swift.String = "label/edited"
        public struct Input: Sendable, Hashable {
            /// - Remark: Generated from `#/paths/label-edited/POST/header`.
            public struct Headers: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/label-edited/POST/header/User-Agent`.
                public var userAgent: Swift.String?
                /// - Remark: Generated from `#/paths/label-edited/POST/header/X-Github-Hook-Id`.
                public var xGithubHookId: Swift.String?
                /// - Remark: Generated from `#/paths/label-edited/POST/header/X-Github-Event`.
                public var xGithubEvent: Swift.String?
                /// - Remark: Generated from `#/paths/label-edited/POST/header/X-Github-Hook-Installation-Target-Id`.
                public var xGithubHookInstallationTargetId: Swift.String?
                /// - Remark: Generated from `#/paths/label-edited/POST/header/X-Github-Hook-Installation-Target-Type`.
                public var xGithubHookInstallationTargetType: Swift.String?
                /// - Remark: Generated from `#/paths/label-edited/POST/header/X-GitHub-Delivery`.
                public var xGitHubDelivery: Swift.String?
                /// - Remark: Generated from `#/paths/label-edited/POST/header/X-Hub-Signature-256`.
                public var xHubSignature256: Swift.String?
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
            ...
            public var headers: Operations.LabelEdited.Input.Headers
            /// - Remark: Generated from `#/paths/label-edited/POST/requestBody`.
            @frozen public enum Body: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/label-edited/POST/requestBody/content/application\/json`.
                case json(Components.Schemas.WebhookLabelEdited)
            }
            public var body: Operations.LabelEdited.Input.Body
            /// Creates a new `Input`.
            ///
            /// - Parameters:
            ///   - headers:
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//label-edited/post(label/edited)/responses/200`.
            ///
            /// HTTP response code: `200 ok`.
            case ok(Operations.LabelEdited.Output.Ok)
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//label-edited/post(label/edited)/responses/200`.
            ///
            ...
            /// - Throws: An error if `self` is not `.ok`.
            /// - SeeAlso: `.ok`.
            public var ok: Operations.LabelEdited.Output.Ok {
                get throws {
                    switch self {
                    case let .ok(response):
                        return response
