...
public protocol APIProtocol: Sendable {
    ...
    ///
    /// - Remark: HTTP `POST /milestone-closed`.
    /// - Remark: Generated from `#/paths//milestone-closed/post(milestone/closed)`.
    func milestoneClosed(_ input: Operations.MilestoneClosed.Input) async throws -> Operations.MilestoneClosed.Output
    /// This event occurs when there is activity relating to milestones. For more information, see "[About milestones](https://docs.github.com/issues/using-labels-and-milestones-to-track-work/about-milestones)." For information about the Milestone APIs, see [the GraphQL documentation](https://docs.github.com/graphql/reference/objects#milestone) and [the REST API documentation](https://docs.github.com/rest/issues/milestones).
    ///
    /// If you want to receive an event when an issue or pull request is added to or removed from a milestone, use the `milestoned` or `demilestoned` action type for the `issues` or `pull_request` events instead.
    ///
    ...
    ///
    /// - Remark: HTTP `POST /milestone-created`.
    /// - Remark: Generated from `#/paths//milestone-created/post(milestone/created)`.
    func milestoneCreated(_ input: Operations.MilestoneCreated.Input) async throws -> Operations.MilestoneCreated.Output
    /// This event occurs when there is activity relating to milestones. For more information, see "[About milestones](https://docs.github.com/issues/using-labels-and-milestones-to-track-work/about-milestones)." For information about the Milestone APIs, see [the GraphQL documentation](https://docs.github.com/graphql/reference/objects#milestone) and [the REST API documentation](https://docs.github.com/rest/issues/milestones).
    ///
    /// If you want to receive an event when an issue or pull request is added to or removed from a milestone, use the `milestoned` or `demilestoned` action type for the `issues` or `pull_request` events instead.
    ///
    ...
    ///
    /// - Remark: HTTP `POST /milestone-deleted`.
    /// - Remark: Generated from `#/paths//milestone-deleted/post(milestone/deleted)`.
    func milestoneDeleted(_ input: Operations.MilestoneDeleted.Input) async throws -> Operations.MilestoneDeleted.Output
    /// This event occurs when there is activity relating to milestones. For more information, see "[About milestones](https://docs.github.com/issues/using-labels-and-milestones-to-track-work/about-milestones)." For information about the Milestone APIs, see [the GraphQL documentation](https://docs.github.com/graphql/reference/objects#milestone) and [the REST API documentation](https://docs.github.com/rest/issues/milestones).
    ///
    /// If you want to receive an event when an issue or pull request is added to or removed from a milestone, use the `milestoned` or `demilestoned` action type for the `issues` or `pull_request` events instead.
    ///
    ...
    ///
    /// - Remark: HTTP `POST /milestone-edited`.
    /// - Remark: Generated from `#/paths//milestone-edited/post(milestone/edited)`.
    func milestoneEdited(_ input: Operations.MilestoneEdited.Input) async throws -> Operations.MilestoneEdited.Output
    /// This event occurs when there is activity relating to milestones. For more information, see "[About milestones](https://docs.github.com/issues/using-labels-and-milestones-to-track-work/about-milestones)." For information about the Milestone APIs, see [the GraphQL documentation](https://docs.github.com/graphql/reference/objects#milestone) and [the REST API documentation](https://docs.github.com/rest/issues/milestones).
    ///
    /// If you want to receive an event when an issue or pull request is added to or removed from a milestone, use the `milestoned` or `demilestoned` action type for the `issues` or `pull_request` events instead.
    ///
    ...
    ///
    /// - Remark: HTTP `POST /milestone-opened`.
    /// - Remark: Generated from `#/paths//milestone-opened/post(milestone/opened)`.
    func milestoneOpened(_ input: Operations.MilestoneOpened.Input) async throws -> Operations.MilestoneOpened.Output
}
...
extension APIProtocol {
    ...
    /// - Remark: HTTP `POST /milestone-closed`.
    /// - Remark: Generated from `#/paths//milestone-closed/post(milestone/closed)`.
    public func milestoneClosed(
        headers: Operations.MilestoneClosed.Input.Headers = .init(),
        body: Operations.MilestoneClosed.Input.Body
    ) async throws -> Operations.MilestoneClosed.Output {
        try await milestoneClosed(Operations.MilestoneClosed.Input(
            headers: headers,
            body: body
        ))
    }
    ...
    /// - Remark: HTTP `POST /milestone-created`.
    /// - Remark: Generated from `#/paths//milestone-created/post(milestone/created)`.
    public func milestoneCreated(
        headers: Operations.MilestoneCreated.Input.Headers = .init(),
        body: Operations.MilestoneCreated.Input.Body
    ) async throws -> Operations.MilestoneCreated.Output {
        try await milestoneCreated(Operations.MilestoneCreated.Input(
            headers: headers,
            body: body
        ))
    }
    ...
    /// - Remark: HTTP `POST /milestone-deleted`.
    /// - Remark: Generated from `#/paths//milestone-deleted/post(milestone/deleted)`.
    public func milestoneDeleted(
        headers: Operations.MilestoneDeleted.Input.Headers = .init(),
        body: Operations.MilestoneDeleted.Input.Body
    ) async throws -> Operations.MilestoneDeleted.Output {
        try await milestoneDeleted(Operations.MilestoneDeleted.Input(
            headers: headers,
            body: body
        ))
    }
    ...
    /// - Remark: HTTP `POST /milestone-edited`.
    /// - Remark: Generated from `#/paths//milestone-edited/post(milestone/edited)`.
    public func milestoneEdited(
        headers: Operations.MilestoneEdited.Input.Headers = .init(),
        body: Operations.MilestoneEdited.Input.Body
    ) async throws -> Operations.MilestoneEdited.Output {
        try await milestoneEdited(Operations.MilestoneEdited.Input(
            headers: headers,
            body: body
        ))
    }
    ...
    /// - Remark: HTTP `POST /milestone-opened`.
    /// - Remark: Generated from `#/paths//milestone-opened/post(milestone/opened)`.
    public func milestoneOpened(
        headers: Operations.MilestoneOpened.Input.Headers = .init(),
        body: Operations.MilestoneOpened.Input.Body
    ) async throws -> Operations.MilestoneOpened.Output {
        try await milestoneOpened(Operations.MilestoneOpened.Input(
            headers: headers,
            body: body
        ))
    }
...
public enum Components {
    ...
    public enum Schemas {
        ...
        /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed`.
        public struct WebhookMilestoneClosed: Codable, Hashable, Sendable {
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/action`.
            @frozen public enum ActionPayload: String, Codable, Hashable, Sendable, CaseIterable {
                case closed = "closed"
            }
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/action`.
            public var action: Components.Schemas.WebhookMilestoneClosed.ActionPayload
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/enterprise`.
            public var enterprise: Components.Schemas.Enterprise?
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/installation`.
            ...
            public struct MilestonePayload: Codable, Hashable, Sendable {
                ...
                public struct CreatorPayload: Codable, Hashable, Sendable {
                    ...
                    public var avatarUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/deleted`.
                    public var deleted: Swift.Bool?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/email`.
                    public var email: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/events_url`.
                    public var eventsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/followers_url`.
                    public var followersUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/following_url`.
                    public var followingUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/gists_url`.
                    public var gistsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/gravatar_id`.
                    public var gravatarId: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/html_url`.
                    public var htmlUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/id`.
                    public var id: Swift.Int
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/login`.
                    public var login: Swift.String
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/name`.
                    public var name: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/node_id`.
                    public var nodeId: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/organizations_url`.
                    public var organizationsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/received_events_url`.
                    public var receivedEventsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/repos_url`.
                    public var reposUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/site_admin`.
                    public var siteAdmin: Swift.Bool?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/starred_url`.
                    public var starredUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/subscriptions_url`.
                    public var subscriptionsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/type`.
                    ...
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/type`.
                    public var _type: Components.Schemas.WebhookMilestoneClosed.MilestonePayload.CreatorPayload._TypePayload?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator/url`.
                    public var url: Swift.String?
                    ...
                    public init(
                        ...
                        starredUrl: Swift.String? = nil,
                        subscriptionsUrl: Swift.String? = nil,
                        _type: Components.Schemas.WebhookMilestoneClosed.MilestonePayload.CreatorPayload._TypePayload? = nil,
                        url: Swift.String? = nil
                    ) {
                        self.avatarUrl = avatarUrl
                ...
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/creator`.
                public var creator: Components.Schemas.WebhookMilestoneClosed.MilestonePayload.CreatorPayload?
                ...
                public var id: Swift.Int
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/labels_url`.
                public var labelsUrl: Swift.String
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/node_id`.
                public var nodeId: Swift.String
                /// The number of the milestone.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/number`.
                public var number: Swift.Int
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/open_issues`.
                public var openIssues: Swift.Int
                /// The state of the milestone.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/state`.
                ...
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone/state`.
                public var state: Components.Schemas.WebhookMilestoneClosed.MilestonePayload.StatePayload
            ...
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/milestone`.
            public var milestone: Components.Schemas.WebhookMilestoneClosed.MilestonePayload
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/organization`.
            public var organization: Components.Schemas.OrganizationSimple?
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/repository`.
            public var repository: Components.Schemas.Repository
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-closed/sender`.
            public var sender: Components.Schemas.SimpleUser
            /// Creates a new `WebhookMilestoneClosed`.
            ///
            /// - Parameters:
            ///   - action:
            ///   - enterprise:
            ...
            ///   - sender:
            public init(
                action: Components.Schemas.WebhookMilestoneClosed.ActionPayload,
                enterprise: Components.Schemas.Enterprise? = nil,
                installation: Components.Schemas.SimpleInstallation? = nil,
                milestone: Components.Schemas.WebhookMilestoneClosed.MilestonePayload,
        ...
        /// - Remark: Generated from `#/components/schemas/webhook-milestone-created`.
        public struct WebhookMilestoneCreated: Codable, Hashable, Sendable {
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/action`.
            @frozen public enum ActionPayload: String, Codable, Hashable, Sendable, CaseIterable {
                case created = "created"
            }
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/action`.
            public var action: Components.Schemas.WebhookMilestoneCreated.ActionPayload
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/enterprise`.
            public var enterprise: Components.Schemas.Enterprise?
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/installation`.
            public var installation: Components.Schemas.SimpleInstallation?
            /// A collection of related issues and pull requests.
            ///
            ...
            public struct MilestonePayload: Codable, Hashable, Sendable {
                ...
                public struct CreatorPayload: Codable, Hashable, Sendable {
                    ...
                    public var avatarUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/deleted`.
                    public var deleted: Swift.Bool?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/email`.
                    public var email: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/events_url`.
                    public var eventsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/followers_url`.
                    public var followersUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/following_url`.
                    public var followingUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/gists_url`.
                    public var gistsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/gravatar_id`.
                    public var gravatarId: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/html_url`.
                    public var htmlUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/id`.
                    public var id: Swift.Int
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/login`.
                    public var login: Swift.String
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/name`.
                    public var name: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/node_id`.
                    public var nodeId: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/organizations_url`.
                    public var organizationsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/received_events_url`.
                    public var receivedEventsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/repos_url`.
                    public var reposUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/site_admin`.
                    public var siteAdmin: Swift.Bool?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/starred_url`.
                    public var starredUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/subscriptions_url`.
                    public var subscriptionsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/type`.
                    @frozen public enum _TypePayload: String, Codable, Hashable, Sendable, CaseIterable {
                        case bot = "Bot"
                        case user = "User"
                        case organization = "Organization"
                    ...
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/type`.
                    public var _type: Components.Schemas.WebhookMilestoneCreated.MilestonePayload.CreatorPayload._TypePayload?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator/url`.
                    public var url: Swift.String?
                    /// Creates a new `CreatorPayload`.
                    ///
                    /// - Parameters:
                    ...
                    public init(
                        ...
                        starredUrl: Swift.String? = nil,
                        subscriptionsUrl: Swift.String? = nil,
                        _type: Components.Schemas.WebhookMilestoneCreated.MilestonePayload.CreatorPayload._TypePayload? = nil,
                        url: Swift.String? = nil
                    ) {
                        self.avatarUrl = avatarUrl
                        self.deleted = deleted
                ...
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/creator`.
                public var creator: Components.Schemas.WebhookMilestoneCreated.MilestonePayload.CreatorPayload?
                ...
                public var id: Swift.Int
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/labels_url`.
                public var labelsUrl: Swift.String
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/node_id`.
                public var nodeId: Swift.String
                /// The number of the milestone.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/number`.
                public var number: Swift.Int
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/open_issues`.
                public var openIssues: Swift.Int
                /// The state of the milestone.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/state`.
                @frozen public enum StatePayload: String, Codable, Hashable, Sendable, CaseIterable {
                    case open = "open"
                    case closed = "closed"
                }
                ...
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone/state`.
                public var state: Components.Schemas.WebhookMilestoneCreated.MilestonePayload.StatePayload
                /// The title of the milestone.
                ///
            ...
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/milestone`.
            public var milestone: Components.Schemas.WebhookMilestoneCreated.MilestonePayload
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/organization`.
            public var organization: Components.Schemas.OrganizationSimple?
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/repository`.
            public var repository: Components.Schemas.Repository
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-created/sender`.
            public var sender: Components.Schemas.SimpleUser
            /// Creates a new `WebhookMilestoneCreated`.
            ///
            /// - Parameters:
            ///   - action:
            ///   - enterprise:
            ...
            ///   - sender:
            public init(
                action: Components.Schemas.WebhookMilestoneCreated.ActionPayload,
                enterprise: Components.Schemas.Enterprise? = nil,
                installation: Components.Schemas.SimpleInstallation? = nil,
                milestone: Components.Schemas.WebhookMilestoneCreated.MilestonePayload,
                organization: Components.Schemas.OrganizationSimple? = nil,
                repository: Components.Schemas.Repository,
                sender: Components.Schemas.SimpleUser
            ) {
        ...
        /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted`.
        public struct WebhookMilestoneDeleted: Codable, Hashable, Sendable {
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/action`.
            @frozen public enum ActionPayload: String, Codable, Hashable, Sendable, CaseIterable {
                case deleted = "deleted"
            }
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/action`.
            public var action: Components.Schemas.WebhookMilestoneDeleted.ActionPayload
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/enterprise`.
            public var enterprise: Components.Schemas.Enterprise?
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/installation`.
            public var installation: Components.Schemas.SimpleInstallation?
            /// A collection of related issues and pull requests.
            ///
            ...
            public struct MilestonePayload: Codable, Hashable, Sendable {
                ...
                public struct CreatorPayload: Codable, Hashable, Sendable {
                    ...
                    public var avatarUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/deleted`.
                    public var deleted: Swift.Bool?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/email`.
                    public var email: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/events_url`.
                    public var eventsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/followers_url`.
                    public var followersUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/following_url`.
                    public var followingUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/gists_url`.
                    public var gistsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/gravatar_id`.
                    public var gravatarId: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/html_url`.
                    public var htmlUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/id`.
                    public var id: Swift.Int
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/login`.
                    public var login: Swift.String
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/name`.
                    public var name: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/node_id`.
                    public var nodeId: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/organizations_url`.
                    public var organizationsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/received_events_url`.
                    public var receivedEventsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/repos_url`.
                    public var reposUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/site_admin`.
                    public var siteAdmin: Swift.Bool?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/starred_url`.
                    public var starredUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/subscriptions_url`.
                    public var subscriptionsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/type`.
                    @frozen public enum _TypePayload: String, Codable, Hashable, Sendable, CaseIterable {
                        case bot = "Bot"
                        case user = "User"
                        case organization = "Organization"
                    ...
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/type`.
                    public var _type: Components.Schemas.WebhookMilestoneDeleted.MilestonePayload.CreatorPayload._TypePayload?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator/url`.
                    public var url: Swift.String?
                    /// Creates a new `CreatorPayload`.
                    ///
                    /// - Parameters:
                    ...
                    public init(
                        ...
                        starredUrl: Swift.String? = nil,
                        subscriptionsUrl: Swift.String? = nil,
                        _type: Components.Schemas.WebhookMilestoneDeleted.MilestonePayload.CreatorPayload._TypePayload? = nil,
                        url: Swift.String? = nil
                    ) {
                        self.avatarUrl = avatarUrl
                        self.deleted = deleted
                ...
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/creator`.
                public var creator: Components.Schemas.WebhookMilestoneDeleted.MilestonePayload.CreatorPayload?
                ...
                public var id: Swift.Int
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/labels_url`.
                public var labelsUrl: Swift.String
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/node_id`.
                public var nodeId: Swift.String
                /// The number of the milestone.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/number`.
                public var number: Swift.Int
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/open_issues`.
                public var openIssues: Swift.Int
                /// The state of the milestone.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/state`.
                @frozen public enum StatePayload: String, Codable, Hashable, Sendable, CaseIterable {
                    case open = "open"
                    case closed = "closed"
                }
                ...
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone/state`.
                public var state: Components.Schemas.WebhookMilestoneDeleted.MilestonePayload.StatePayload
                /// The title of the milestone.
                ///
            ...
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/milestone`.
            public var milestone: Components.Schemas.WebhookMilestoneDeleted.MilestonePayload
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/organization`.
            public var organization: Components.Schemas.OrganizationSimple?
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/repository`.
            public var repository: Components.Schemas.Repository
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-deleted/sender`.
            public var sender: Components.Schemas.SimpleUser
            /// Creates a new `WebhookMilestoneDeleted`.
            ///
            /// - Parameters:
            ///   - action:
            ///   - enterprise:
            ...
            ///   - sender:
            public init(
                action: Components.Schemas.WebhookMilestoneDeleted.ActionPayload,
                enterprise: Components.Schemas.Enterprise? = nil,
                installation: Components.Schemas.SimpleInstallation? = nil,
                milestone: Components.Schemas.WebhookMilestoneDeleted.MilestonePayload,
                organization: Components.Schemas.OrganizationSimple? = nil,
                repository: Components.Schemas.Repository,
                sender: Components.Schemas.SimpleUser
            ) {
        ...
        /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited`.
        public struct WebhookMilestoneEdited: Codable, Hashable, Sendable {
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/action`.
            @frozen public enum ActionPayload: String, Codable, Hashable, Sendable, CaseIterable {
                case edited = "edited"
            }
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/action`.
            public var action: Components.Schemas.WebhookMilestoneEdited.ActionPayload
            /// The changes to the milestone if the action was `edited`.
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/changes`.
            public struct ChangesPayload: Codable, Hashable, Sendable {
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/changes/description`.
                public struct DescriptionPayload: Codable, Hashable, Sendable {
                    /// The previous version of the description if the action was `edited`.
                    ///
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/changes/description/from`.
                ...
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/changes/description`.
                public var description: Components.Schemas.WebhookMilestoneEdited.ChangesPayload.DescriptionPayload?
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/changes/due_on`.
                public struct DueOnPayload: Codable, Hashable, Sendable {
                    /// The previous version of the due date if the action was `edited`.
                    ///
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/changes/due_on/from`.
                    public var from: Swift.String
                    /// Creates a new `DueOnPayload`.
                    ///
                    /// - Parameters:
                ...
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/changes/due_on`.
                public var dueOn: Components.Schemas.WebhookMilestoneEdited.ChangesPayload.DueOnPayload?
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/changes/title`.
                public struct TitlePayload: Codable, Hashable, Sendable {
                    /// The previous version of the title if the action was `edited`.
                    ///
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/changes/title/from`.
                    public var from: Swift.String
                ...
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/changes/title`.
                public var title: Components.Schemas.WebhookMilestoneEdited.ChangesPayload.TitlePayload?
                ...
                ///   - title:
                public init(
                    description: Components.Schemas.WebhookMilestoneEdited.ChangesPayload.DescriptionPayload? = nil,
                    dueOn: Components.Schemas.WebhookMilestoneEdited.ChangesPayload.DueOnPayload? = nil,
                    title: Components.Schemas.WebhookMilestoneEdited.ChangesPayload.TitlePayload? = nil
                ) {
                    self.description = description
                    self.dueOn = dueOn
                    self.title = title
            ...
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/changes`.
            public var changes: Components.Schemas.WebhookMilestoneEdited.ChangesPayload
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/enterprise`.
            public var enterprise: Components.Schemas.Enterprise?
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/installation`.
            public var installation: Components.Schemas.SimpleInstallation?
            /// A collection of related issues and pull requests.
            ///
            ...
            public struct MilestonePayload: Codable, Hashable, Sendable {
                ...
                public struct CreatorPayload: Codable, Hashable, Sendable {
                    ...
                    public var avatarUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/deleted`.
                    public var deleted: Swift.Bool?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/email`.
                    public var email: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/events_url`.
                    public var eventsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/followers_url`.
                    public var followersUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/following_url`.
                    public var followingUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/gists_url`.
                    public var gistsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/gravatar_id`.
                    public var gravatarId: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/html_url`.
                    public var htmlUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/id`.
                    public var id: Swift.Int
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/login`.
                    public var login: Swift.String
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/name`.
                    public var name: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/node_id`.
                    public var nodeId: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/organizations_url`.
                    public var organizationsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/received_events_url`.
                    public var receivedEventsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/repos_url`.
                    public var reposUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/site_admin`.
                    public var siteAdmin: Swift.Bool?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/starred_url`.
                    public var starredUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/subscriptions_url`.
                    public var subscriptionsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/type`.
                    @frozen public enum _TypePayload: String, Codable, Hashable, Sendable, CaseIterable {
                        case bot = "Bot"
                        case user = "User"
                        case organization = "Organization"
                    ...
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/type`.
                    public var _type: Components.Schemas.WebhookMilestoneEdited.MilestonePayload.CreatorPayload._TypePayload?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator/url`.
                    public var url: Swift.String?
                    /// Creates a new `CreatorPayload`.
                    ///
                    /// - Parameters:
                    ...
                    public init(
                        ...
                        starredUrl: Swift.String? = nil,
                        subscriptionsUrl: Swift.String? = nil,
                        _type: Components.Schemas.WebhookMilestoneEdited.MilestonePayload.CreatorPayload._TypePayload? = nil,
                        url: Swift.String? = nil
                    ) {
                        self.avatarUrl = avatarUrl
                        self.deleted = deleted
                ...
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/creator`.
                public var creator: Components.Schemas.WebhookMilestoneEdited.MilestonePayload.CreatorPayload?
                ...
                public var id: Swift.Int
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/labels_url`.
                public var labelsUrl: Swift.String
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/node_id`.
                public var nodeId: Swift.String
                /// The number of the milestone.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/number`.
                public var number: Swift.Int
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/open_issues`.
                public var openIssues: Swift.Int
                /// The state of the milestone.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/state`.
                @frozen public enum StatePayload: String, Codable, Hashable, Sendable, CaseIterable {
                    case open = "open"
                    case closed = "closed"
                }
                ...
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone/state`.
                public var state: Components.Schemas.WebhookMilestoneEdited.MilestonePayload.StatePayload
                /// The title of the milestone.
                ///
            ...
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/milestone`.
            public var milestone: Components.Schemas.WebhookMilestoneEdited.MilestonePayload
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/organization`.
            public var organization: Components.Schemas.OrganizationSimple?
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/repository`.
            public var repository: Components.Schemas.Repository
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-edited/sender`.
            public var sender: Components.Schemas.SimpleUser
            /// Creates a new `WebhookMilestoneEdited`.
            ///
            /// - Parameters:
            ///   - action:
            ...
            ///   - sender:
            public init(
                action: Components.Schemas.WebhookMilestoneEdited.ActionPayload,
                changes: Components.Schemas.WebhookMilestoneEdited.ChangesPayload,
                enterprise: Components.Schemas.Enterprise? = nil,
                installation: Components.Schemas.SimpleInstallation? = nil,
                milestone: Components.Schemas.WebhookMilestoneEdited.MilestonePayload,
                organization: Components.Schemas.OrganizationSimple? = nil,
                repository: Components.Schemas.Repository,
                sender: Components.Schemas.SimpleUser
            ) {
        ...
        /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened`.
        public struct WebhookMilestoneOpened: Codable, Hashable, Sendable {
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/action`.
            @frozen public enum ActionPayload: String, Codable, Hashable, Sendable, CaseIterable {
                case opened = "opened"
            }
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/action`.
            public var action: Components.Schemas.WebhookMilestoneOpened.ActionPayload
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/enterprise`.
            public var enterprise: Components.Schemas.Enterprise?
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/installation`.
            public var installation: Components.Schemas.SimpleInstallation?
            /// A collection of related issues and pull requests.
            ///
            ...
            public struct MilestonePayload: Codable, Hashable, Sendable {
                ...
                public struct CreatorPayload: Codable, Hashable, Sendable {
                    ...
                    public var avatarUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/deleted`.
                    public var deleted: Swift.Bool?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/email`.
                    public var email: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/events_url`.
                    public var eventsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/followers_url`.
                    public var followersUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/following_url`.
                    public var followingUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/gists_url`.
                    public var gistsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/gravatar_id`.
                    public var gravatarId: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/html_url`.
                    public var htmlUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/id`.
                    public var id: Swift.Int
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/login`.
                    public var login: Swift.String
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/name`.
                    public var name: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/node_id`.
                    public var nodeId: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/organizations_url`.
                    public var organizationsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/received_events_url`.
                    public var receivedEventsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/repos_url`.
                    public var reposUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/site_admin`.
                    public var siteAdmin: Swift.Bool?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/starred_url`.
                    public var starredUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/subscriptions_url`.
                    public var subscriptionsUrl: Swift.String?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/type`.
                    @frozen public enum _TypePayload: String, Codable, Hashable, Sendable, CaseIterable {
                        case bot = "Bot"
                        case user = "User"
                        case organization = "Organization"
                    ...
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/type`.
                    public var _type: Components.Schemas.WebhookMilestoneOpened.MilestonePayload.CreatorPayload._TypePayload?
                    /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator/url`.
                    public var url: Swift.String?
                    /// Creates a new `CreatorPayload`.
                    ///
                    /// - Parameters:
                    ...
                    public init(
                        ...
                        starredUrl: Swift.String? = nil,
                        subscriptionsUrl: Swift.String? = nil,
                        _type: Components.Schemas.WebhookMilestoneOpened.MilestonePayload.CreatorPayload._TypePayload? = nil,
                        url: Swift.String? = nil
                    ) {
                        self.avatarUrl = avatarUrl
                        self.deleted = deleted
                ...
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/creator`.
                public var creator: Components.Schemas.WebhookMilestoneOpened.MilestonePayload.CreatorPayload?
                ...
                public var id: Swift.Int
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/labels_url`.
                public var labelsUrl: Swift.String
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/node_id`.
                public var nodeId: Swift.String
                /// The number of the milestone.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/number`.
                public var number: Swift.Int
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/open_issues`.
                public var openIssues: Swift.Int
                /// The state of the milestone.
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/state`.
                @frozen public enum StatePayload: String, Codable, Hashable, Sendable, CaseIterable {
                    case open = "open"
                    case closed = "closed"
                }
                ...
                ///
                /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone/state`.
                public var state: Components.Schemas.WebhookMilestoneOpened.MilestonePayload.StatePayload
                /// The title of the milestone.
                ///
            ...
            ///
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/milestone`.
            public var milestone: Components.Schemas.WebhookMilestoneOpened.MilestonePayload
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/organization`.
            public var organization: Components.Schemas.OrganizationSimple?
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/repository`.
            public var repository: Components.Schemas.Repository
            /// - Remark: Generated from `#/components/schemas/webhook-milestone-opened/sender`.
            public var sender: Components.Schemas.SimpleUser
            /// Creates a new `WebhookMilestoneOpened`.
            ///
            /// - Parameters:
            ///   - action:
            ///   - enterprise:
            ...
            ///   - sender:
            public init(
                action: Components.Schemas.WebhookMilestoneOpened.ActionPayload,
                enterprise: Components.Schemas.Enterprise? = nil,
                installation: Components.Schemas.SimpleInstallation? = nil,
                milestone: Components.Schemas.WebhookMilestoneOpened.MilestonePayload,
                organization: Components.Schemas.OrganizationSimple? = nil,
                repository: Components.Schemas.Repository,
                sender: Components.Schemas.SimpleUser
            ) {
...
public enum Operations {
    ...
    /// - Remark: HTTP `POST /milestone-closed`.
    /// - Remark: Generated from `#/paths//milestone-closed/post(milestone/closed)`.
    public enum MilestoneClosed {
        public static let id: Swift.String = "milestone/closed"
        public struct Input: Sendable, Hashable {
            /// - Remark: Generated from `#/paths/milestone-closed/POST/header`.
            public struct Headers: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/milestone-closed/POST/header/User-Agent`.
                public var userAgent: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-closed/POST/header/X-Github-Hook-Id`.
                public var xGithubHookId: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-closed/POST/header/X-Github-Event`.
                public var xGithubEvent: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-closed/POST/header/X-Github-Hook-Installation-Target-Id`.
                public var xGithubHookInstallationTargetId: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-closed/POST/header/X-Github-Hook-Installation-Target-Type`.
                public var xGithubHookInstallationTargetType: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-closed/POST/header/X-GitHub-Delivery`.
                public var xGitHubDelivery: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-closed/POST/header/X-Hub-Signature-256`.
            ...
            public var headers: Operations.MilestoneClosed.Input.Headers
            /// - Remark: Generated from `#/paths/milestone-closed/POST/requestBody`.
            @frozen public enum Body: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/milestone-closed/POST/requestBody/content/application\/json`.
                case json(Components.Schemas.WebhookMilestoneClosed)
            }
            public var body: Operations.MilestoneClosed.Input.Body
            /// Creates a new `Input`.
            ///
            /// - Parameters:
            ///   - headers:
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            ///
            /// - Remark: Generated from `#/paths//milestone-closed/post(milestone/closed)/responses/200`.
            ///
            /// HTTP response code: `200 ok`.
            case ok(Operations.MilestoneClosed.Output.Ok)
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//milestone-closed/post(milestone/closed)/responses/200`.
            ///
            ...
            /// - SeeAlso: `.ok`.
            public var ok: Operations.MilestoneClosed.Output.Ok {
                get throws {
                    switch self {
    ...
    /// - Remark: HTTP `POST /milestone-created`.
    /// - Remark: Generated from `#/paths//milestone-created/post(milestone/created)`.
    public enum MilestoneCreated {
        public static let id: Swift.String = "milestone/created"
        public struct Input: Sendable, Hashable {
            /// - Remark: Generated from `#/paths/milestone-created/POST/header`.
            public struct Headers: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/milestone-created/POST/header/User-Agent`.
                public var userAgent: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-created/POST/header/X-Github-Hook-Id`.
                public var xGithubHookId: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-created/POST/header/X-Github-Event`.
                public var xGithubEvent: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-created/POST/header/X-Github-Hook-Installation-Target-Id`.
                public var xGithubHookInstallationTargetId: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-created/POST/header/X-Github-Hook-Installation-Target-Type`.
                public var xGithubHookInstallationTargetType: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-created/POST/header/X-GitHub-Delivery`.
                public var xGitHubDelivery: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-created/POST/header/X-Hub-Signature-256`.
                public var xHubSignature256: Swift.String?
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
            ...
            public var headers: Operations.MilestoneCreated.Input.Headers
            /// - Remark: Generated from `#/paths/milestone-created/POST/requestBody`.
            @frozen public enum Body: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/milestone-created/POST/requestBody/content/application\/json`.
                case json(Components.Schemas.WebhookMilestoneCreated)
            }
            public var body: Operations.MilestoneCreated.Input.Body
            /// Creates a new `Input`.
            ///
            /// - Parameters:
            ///   - headers:
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//milestone-created/post(milestone/created)/responses/200`.
            ///
            /// HTTP response code: `200 ok`.
            case ok(Operations.MilestoneCreated.Output.Ok)
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//milestone-created/post(milestone/created)/responses/200`.
            ///
            ...
            /// - Throws: An error if `self` is not `.ok`.
            /// - SeeAlso: `.ok`.
            public var ok: Operations.MilestoneCreated.Output.Ok {
                get throws {
                    switch self {
                    case let .ok(response):
                        return response
    ...
    /// - Remark: HTTP `POST /milestone-deleted`.
    /// - Remark: Generated from `#/paths//milestone-deleted/post(milestone/deleted)`.
    public enum MilestoneDeleted {
        public static let id: Swift.String = "milestone/deleted"
        public struct Input: Sendable, Hashable {
            /// - Remark: Generated from `#/paths/milestone-deleted/POST/header`.
            public struct Headers: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/milestone-deleted/POST/header/User-Agent`.
                public var userAgent: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-deleted/POST/header/X-Github-Hook-Id`.
                public var xGithubHookId: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-deleted/POST/header/X-Github-Event`.
                public var xGithubEvent: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-deleted/POST/header/X-Github-Hook-Installation-Target-Id`.
                public var xGithubHookInstallationTargetId: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-deleted/POST/header/X-Github-Hook-Installation-Target-Type`.
                public var xGithubHookInstallationTargetType: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-deleted/POST/header/X-GitHub-Delivery`.
                public var xGitHubDelivery: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-deleted/POST/header/X-Hub-Signature-256`.
                public var xHubSignature256: Swift.String?
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
            ...
            public var headers: Operations.MilestoneDeleted.Input.Headers
            /// - Remark: Generated from `#/paths/milestone-deleted/POST/requestBody`.
            @frozen public enum Body: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/milestone-deleted/POST/requestBody/content/application\/json`.
                case json(Components.Schemas.WebhookMilestoneDeleted)
            }
            public var body: Operations.MilestoneDeleted.Input.Body
            /// Creates a new `Input`.
            ///
            /// - Parameters:
            ///   - headers:
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//milestone-deleted/post(milestone/deleted)/responses/200`.
            ///
            /// HTTP response code: `200 ok`.
            case ok(Operations.MilestoneDeleted.Output.Ok)
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//milestone-deleted/post(milestone/deleted)/responses/200`.
            ///
            ...
            /// - Throws: An error if `self` is not `.ok`.
            /// - SeeAlso: `.ok`.
            public var ok: Operations.MilestoneDeleted.Output.Ok {
                get throws {
                    switch self {
                    case let .ok(response):
                        return response
    ...
    /// - Remark: HTTP `POST /milestone-edited`.
    /// - Remark: Generated from `#/paths//milestone-edited/post(milestone/edited)`.
    public enum MilestoneEdited {
        public static let id: Swift.String = "milestone/edited"
        public struct Input: Sendable, Hashable {
            /// - Remark: Generated from `#/paths/milestone-edited/POST/header`.
            public struct Headers: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/milestone-edited/POST/header/User-Agent`.
                public var userAgent: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-edited/POST/header/X-Github-Hook-Id`.
                public var xGithubHookId: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-edited/POST/header/X-Github-Event`.
                public var xGithubEvent: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-edited/POST/header/X-Github-Hook-Installation-Target-Id`.
                public var xGithubHookInstallationTargetId: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-edited/POST/header/X-Github-Hook-Installation-Target-Type`.
                public var xGithubHookInstallationTargetType: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-edited/POST/header/X-GitHub-Delivery`.
                public var xGitHubDelivery: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-edited/POST/header/X-Hub-Signature-256`.
                public var xHubSignature256: Swift.String?
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
            ...
            public var headers: Operations.MilestoneEdited.Input.Headers
            /// - Remark: Generated from `#/paths/milestone-edited/POST/requestBody`.
            @frozen public enum Body: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/milestone-edited/POST/requestBody/content/application\/json`.
                case json(Components.Schemas.WebhookMilestoneEdited)
            }
            public var body: Operations.MilestoneEdited.Input.Body
            /// Creates a new `Input`.
            ///
            /// - Parameters:
            ///   - headers:
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//milestone-edited/post(milestone/edited)/responses/200`.
            ///
            /// HTTP response code: `200 ok`.
            case ok(Operations.MilestoneEdited.Output.Ok)
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//milestone-edited/post(milestone/edited)/responses/200`.
            ///
            ...
            /// - Throws: An error if `self` is not `.ok`.
            /// - SeeAlso: `.ok`.
            public var ok: Operations.MilestoneEdited.Output.Ok {
                get throws {
                    switch self {
                    case let .ok(response):
                        return response
    ...
    /// - Remark: HTTP `POST /milestone-opened`.
    /// - Remark: Generated from `#/paths//milestone-opened/post(milestone/opened)`.
    public enum MilestoneOpened {
        public static let id: Swift.String = "milestone/opened"
        public struct Input: Sendable, Hashable {
            /// - Remark: Generated from `#/paths/milestone-opened/POST/header`.
            public struct Headers: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/milestone-opened/POST/header/User-Agent`.
                public var userAgent: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-opened/POST/header/X-Github-Hook-Id`.
                public var xGithubHookId: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-opened/POST/header/X-Github-Event`.
                public var xGithubEvent: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-opened/POST/header/X-Github-Hook-Installation-Target-Id`.
                public var xGithubHookInstallationTargetId: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-opened/POST/header/X-Github-Hook-Installation-Target-Type`.
                public var xGithubHookInstallationTargetType: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-opened/POST/header/X-GitHub-Delivery`.
                public var xGitHubDelivery: Swift.String?
                /// - Remark: Generated from `#/paths/milestone-opened/POST/header/X-Hub-Signature-256`.
                public var xHubSignature256: Swift.String?
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
            ...
            public var headers: Operations.MilestoneOpened.Input.Headers
            /// - Remark: Generated from `#/paths/milestone-opened/POST/requestBody`.
            @frozen public enum Body: Sendable, Hashable {
                /// - Remark: Generated from `#/paths/milestone-opened/POST/requestBody/content/application\/json`.
                case json(Components.Schemas.WebhookMilestoneOpened)
            }
            public var body: Operations.MilestoneOpened.Input.Body
            /// Creates a new `Input`.
            ///
            /// - Parameters:
            ///   - headers:
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//milestone-opened/post(milestone/opened)/responses/200`.
            ///
            /// HTTP response code: `200 ok`.
            case ok(Operations.MilestoneOpened.Output.Ok)
            /// Return a 200 status to indicate that the data was received successfully
            ///
            /// - Remark: Generated from `#/paths//milestone-opened/post(milestone/opened)/responses/200`.
            ///
            ...
            /// - Throws: An error if `self` is not `.ok`.
            /// - SeeAlso: `.ok`.
            public var ok: Operations.MilestoneOpened.Output.Ok {
                get throws {
                    switch self {
                    case let .ok(response):
                        return response
